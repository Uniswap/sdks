...
export interface LimitOrderReactorInterface extends utils.Interface {
  functions: {
...
export interface LimitOrderReactor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LimitOrderReactorInterface;
