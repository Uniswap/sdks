...
export interface PermitPostInterface extends utils.Interface {
  functions: {
    ...
    "unorderedTransferFrom(((uint8,address,uint256,uint256)[],address,uint256,bytes32),address,address[],uint256[],uint256[],uint256,(uint8,bytes32,bytes32))": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "bitmapPositions"
      | "isUsedUnorderedNonce"
      | "nonceBitmap"
      | "nonces"
      | "transferFrom"
      | "unorderedTransferFrom"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "bitmapPositions",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "isUsedUnorderedNonce",
  ...
  encodeFunctionData(
    functionFragment: "unorderedTransferFrom",
    values: [
      PermitStruct,
      PromiseOrValue<string>,
      PromiseOrValue<string>[],
...
export interface PermitPost extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber, number] & { wordPos: BigNumber; bitPos: number }>;
