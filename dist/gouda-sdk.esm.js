import { ethers, utils, Contract, ContractFactory, BigNumber } from 'ethers';
import { hexConcat, splitSignature } from '@ethersproject/bytes';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            data = hexConcat([DEPLOYLESS_MULTICALL_BYTECODE, args]);
            _context2.next = 15;
          ...
          case 15:
            ...
            multicallInterface = new Interface(multicall2Abi);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              return _context2.abrupt("return", bitmap.div(BigNumber.from(2).pow(bitPos)).mod(2).eq(1));
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              currentWord = this.currentWord.get(address) || BigNumber.from(0);
            ...
            case 7:
              if (!bitmap.eq(ethers.constants.MaxUint256)) {
                _context3.next = 14;
                break;
              }
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              calls = orders.map(function (order) {
                var _splitSignature = splitSignature(order.signature),
                    v = _splitSignature.v,
                    r = _splitSignature.r,
                    s = _splitSignature.s;
                    ...
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        ...
                        case 5:
                          ...
                          return _context4.abrupt("return", OrderValidation.AlreadyFilled);
                        ...
                        case 20:
                          ...
                          return _context4.abrupt("return", cancelled ? OrderValidation.Cancelled : validation);
...
var DutchLimitOrder = /*#__PURE__*/function () {
  ...
  _proto.getSigner = function getSigner(signature) {
    return ethers.utils.computeAddress(ethers.utils.recoverPublicKey(this.permitPost.getPermitDigest(this.permitData().values), signature));
  }
  /**
   * @inheritdoc IOrder
   */
...
var OrderBuilder = /*#__PURE__*/function () {
  ...
  _proto.deadline = function deadline(_deadline) {
    !(_deadline > new Date().getTime() / 1000) ? process.env.NODE_ENV !== "production" ? invariant(false, "Deadline must be in the future: " + _deadline) : invariant(false) : void 0;
  ...
  _proto.getOrderInfo = function getOrderInfo() {
    !(this.orderInfo.reactor !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, 'reactor not set') : invariant(false) : void 0;
    !(this.orderInfo.nonce !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, 'nonce not set') : invariant(false) : void 0;
    !(this.orderInfo.deadline !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, 'deadline not set') : invariant(false) : void 0;
    return {
...
var DutchLimitOrderBuilder = /*#__PURE__*/function (_OrderBuilder) {
  ...
  _proto.startTime = function startTime(_startTime) {
    !(!this.info.endTime || _startTime <= this.info.endTime) ? process.env.NODE_ENV !== "production" ? invariant(false, "startTime must be before endTime: " + _startTime) : invariant(false) : void 0;
    !(!this.orderInfo.deadline || _startTime <= this.orderInfo.deadline) ? process.env.NODE_ENV !== "production" ? invariant(false, "startTime must be before deadline: " + _startTime) : invariant(false) : void 0;
    this.info.startTime = _startTime;
    return this;
  };

  _proto.endTime = function endTime(_endTime) {
    !(!this.info.startTime || _endTime >= this.info.startTime) ? process.env.NODE_ENV !== "production" ? invariant(false, "endTime must be after startTime: " + _endTime) : invariant(false) : void 0;
    !(!this.orderInfo.deadline || _endTime <= this.orderInfo.deadline) ? process.env.NODE_ENV !== "production" ? invariant(false, "endTime must be before deadline: " + _endTime) : invariant(false) : void 0;
  ...
  _proto.build = function build() {
    !(this.info.startTime !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, 'startTime not set') : invariant(false) : void 0;
    !(this.info.endTime !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, 'endTime not set') : invariant(false) : void 0;
    !(this.info.input !== undefined) ? process.env.NODE_ENV !== "production" ? invariant(false, 'input not set') : invariant(false) : void 0;
    !(this.info.outputs !== undefined && this.info.outputs.length !== 0) ? process.env.NODE_ENV !== "production" ? invariant(false, 'outputs not set') : invariant(false) : void 0;
