...
const OPTIMISM_SEPOLIA_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0xdA75cEf1C93078e8b736FCA5D5a30adb97C8957d",
...
const ZORA_SEPOLIA_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0xB8458EaAe43292e3c1F7994EFd016bd653d23c20",
...
const BLAST_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0xB218e4f7cF0533d4696fDfC419A0023D33345F28",
...
const UNICHAIN_SEPOLIA_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0xB7F724d6dDDFd008eFf5cc2834edDE5F9eF0d075",
...
const SONEIUM_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0x56c1205b0244332011c1e866f4ea5384eb6bfa2c",
...
const MOONBEAM_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0x9036D0DcB5a059C9371B05D508f0072Df773854e",
...
const LENS_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0xC5d0CAaE8aa00032F6DA993A69Ffa6ff80b5F031",
...
const ZKLINK_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0xAA904d497e42608C014BE83a026E984aFc16129b",
...
const SEI_TESTNET_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0x2d1886A4C71df03685ba1e6B0075e285a34e2c30",
...
const MANTA_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0xA4F2Db71348697C65A64a146F709C73030C2ebcD",
...
const HEMI_ADDRESSES: ChainAddresses = {
	...
	nonfungiblePositionManagerAddress:
		"0xEFdE184f4b5d79f7c3b7Efc0388d829ff9af0050",
...
export const MIXED_ROUTE_QUOTER_V1_ADDRESSES: AddressMap =
	SUPPORTED_CHAINS.reduce<AddressMap>((memo, chainId) => {
		const mixedRouteQuoterV1Address =
			CHAIN_TO_ADDRESSES_MAP[chainId].mixedRouteQuoterV1Address;
...
export const SWAP_ROUTER_02_ADDRESSES = (chainId: number) => {
	if (SUPPORTED_CHAINS.includes(chainId)) {
		...
		return (
			CHAIN_TO_ADDRESSES_MAP[id].swapRouter02Address ??
