...
export class V4Planner {
  ...
  addTrade(
    ...
    invariant(
      !maxHopSlippage || maxHopSlippage.length === trade.route.pools.length,
    ...
    const swapStruct = exactOutput
      ? {
          ...
          ...(urVersion === URVersion.V2_1_1 && { maxHopSlippage: maxHopSlippage ?? [] }),
  ...
  private addSwapAction(type: Actions, parameters: any[], urVersion: URVersion): V4Planner {
    ...
    const abiDef = urVersion === URVersion.V2_1_1 ? V4_SWAP_ACTIONS_V2_1_1[type] : V4_BASE_ACTIONS_ABI_DEFINITION[type]
...
function createAction(action: Actions, parameters: any[], urVersion: URVersion = URVersion.V2_0): RouterAction {
  const abiDef =
    urVersion === URVersion.V2_1_1 && action in V4_SWAP_ACTIONS_V2_1_1
