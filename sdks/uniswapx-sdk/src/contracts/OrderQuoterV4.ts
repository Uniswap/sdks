...
export interface OrderQuoterV4Interface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getAuctionResolver" | "quote" | "reactorCallback"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "getAuctionResolver",
...
export interface OrderQuoterV4 extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[string] & { auctionResolver: string }>;
