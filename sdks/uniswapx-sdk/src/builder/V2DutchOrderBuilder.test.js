...
const V2DutchOrderBuilder_1 = require("./V2DutchOrderBuilder");
...
describe("V2DutchOrderBuilder", () => {
    let builder;
    beforeEach(() => {
        builder = new V2DutchOrderBuilder_1.V2DutchOrderBuilder(1, ethers_1.constants.AddressZero);
    });
    ...
    it("Regenerates builder from order json", () => {
        ...
        const regenerated = V2DutchOrderBuilder_1.V2DutchOrderBuilder.fromOrder(order_1.CosignedV2DutchOrder.fromJSON(json, 1)).build();
    ...
    it("Regenerates builder allows modification", () => {
        ...
        const order = builder
            ...
            .validation(validationInfo)
            .build();
        const regenerated = V2DutchOrderBuilder_1.V2DutchOrderBuilder.fromOrder(order)
    ...
    it("Unknown chainId", () => {
        ...
        expect(() => new V2DutchOrderBuilder_1.V2DutchOrderBuilder(chainId)).toThrow(`Missing configuration for reactor: ${chainId}`);
    });
