...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from '@taraswap/sdk-core'
import { abi } from '@uniswap/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from '@taraswap/v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
      ...
      for (const { route, inputAmount, outputAmount } of trades.swaps) {
        if (route.protocol === Protocol.V2) {
          individualTrades.push(
            new V2Trade(
              route as any as RouteV2<Currency, Currency>,
          ...
          individualTrades.push(
            V3Trade.createUncheckedTrade({
              route: route as any as RouteV3<Currency, Currency>,
              inputAmount,
              outputAmount,
