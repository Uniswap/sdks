import { BigintIsh, CurrencyAmount, Ether, Percent, Token, TradeType, WETH9 } from '@x-swap-protocol/sdk-core'
import { Pair, Route as V2Route, Trade as V2Trade } from '@x-swap-protocol/v2-sdk'
import {
  encodeSqrtRatioX96,
  FeeAmount,
  nearestUsableTick,
