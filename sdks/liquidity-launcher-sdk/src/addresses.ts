...
// the 2026-09-08 v3.3.0 pair launched nothing and is dropped. This pair pins the same v3.2.0
// FeeSplitters, vault and compounding recipient as the 2026-09-01 generation. Superseded by the
// buyback-and-burn pair below, but the fees-off strategy has indexed launches, so it stays.
...
// v3.3.0 buyback-and-burn pair (2026-09-15, current): same launcher, vault and pool shape, but new
// FeeSplitters whose non-creator share goes to the BuybackAndBurnRecipient instead of compounding.
const INSTANT_LAUNCH_STRATEGY_FEES_ON_ARC_V330_BUYBACK = getAddress('0x58E5099f22008bc280152c13b636c88d0fE3E132')
const INSTANT_LAUNCH_STRATEGY_FEES_OFF_ARC_V330_BUYBACK = getAddress('0x36F8c87047b212589eD66524Bb69cE62B1f00B2d')
const INSTANT_LAUNCH_FEE_SPLITTER_FEES_ON_ARC_V330_BUYBACK = getAddress('0xdaA7C2e833Ba71a206f56276b58926A33fB37C33')
const INSTANT_LAUNCH_FEE_SPLITTER_FEES_OFF_ARC_V330_BUYBACK = getAddress('0xE8113a9a9CddD6d13fe8A3E32eAA687e108C4616')
...
export const INSTANT_LAUNCH_DEPLOYMENTS: readonly InstantLaunchDeployment[] = [
  ...
  },
  {
    ...
    minLaunchTick: -160100,
    description:
      'Instant Launch with creator fees (Arc/5042 v3.3.0, 2026-09-14 redeploy): unchanged native-USDC pool shape (TICK_SPACING 25, initialTick 122,050, MIN_LAUNCH_TICK -160,100); reuses the v3.2.0 FeeSplitter forwarding 40% of native fees to the Arc UERC20BeneficiaryVault, 60% native + 100% token to the Arc CompoundingClaimRecipient',
  },
  {
    chainId: SupportedChainId.ARC,
    ...
    minLaunchTick: -160100,
    description:
      'Instant Launch without creator fees (Arc/5042 v3.3.0, 2026-09-14 redeploy): unchanged native-USDC pool shape (TICK_SPACING 25, initialTick 122,050, MIN_LAUNCH_TICK -160,100); zero beneficiary vault; reuses the v3.2.0 FeeSplitter forwarding 100% of both fee sides to the Arc CompoundingClaimRecipient',
  },
  {
    chainId: SupportedChainId.ARC,
    strategy: INSTANT_LAUNCH_STRATEGY_FEES_ON_ARC_V330_BUYBACK,
    feeSplitter: INSTANT_LAUNCH_FEE_SPLITTER_FEES_ON_ARC_V330_BUYBACK,
    creatorFeesEnabled: true,
    creatorFeeNativeBps: 4000,
    creatorFeeTokenBps: 0,
    tickSpacing: 25,
  ...
  {
    chainId: SupportedChainId.ARC,
    strategy: INSTANT_LAUNCH_STRATEGY_FEES_OFF_ARC_V330_BUYBACK,
    feeSplitter: INSTANT_LAUNCH_FEE_SPLITTER_FEES_OFF_ARC_V330_BUYBACK,
    creatorFeesEnabled: false,
    creatorFeeNativeBps: 0,
    creatorFeeTokenBps: 0,
    tickSpacing: 25,
    ...
    minLaunchTick: -160100,
    description:
      'Instant Launch without creator fees (Arc/5042 v3.3.0 buyback-and-burn, current): unchanged native-USDC pool shape (TICK_SPACING 25, initialTick 122,050, MIN_LAUNCH_TICK -160,100); zero beneficiary vault; new FeeSplitter forwarding 100% of both fee sides to the Arc BuybackAndBurnRecipient',
  },
]
...
export const INSTANT_LAUNCH_CONTRACTS: Partial<Record<number, InstantLaunchChainContracts>> = {
  ...
  [SupportedChainId.ARC]: {
    ...
    // Claim surface of the v3.2.0 splitters (2026-09-01 and 2026-09-14 generations).
