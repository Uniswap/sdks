...
import {
  percentToScalingFactor,
  scalingFactorToPercent,
  basisPointsToScalingFactor,
  createDutchAuction,
  createReverseDutchAuction,
  createSteppedPrice,
  createSteppedPriceSchedule,
  getPriceAtBlock,
  getCurveDuration,
  validatePriceCurve,
  concatenateCurves,
  addPlateau,
  createFlatPrice,
  createMultiPhaseAuction,
  DutchAuctionConfig,
  ReverseDutchAuctionConfig,
...
describe('Price Curve Calculators', () => {
  ...
  describe('createDutchAuction', () => {
    it('should create linear Dutch auction (150% → 100%)', () => {
      const config: DutchAuctionConfig = {
  ...
  describe('createReverseDutchAuction', () => {
    it('should create linear reverse Dutch auction (50% → 100%)', () => {
      const config: ReverseDutchAuctionConfig = {
