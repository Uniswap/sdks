...
import { createCompactClient } from './coreClient';
...
describe('createCompactClient', () => {
    ...
    describe('error cases', () => {
        it('should throw for unsupported chain without explicit address', () => {
            ...
            expect(() => createCompactClient(config)).toThrow('No default deployment found for chain 999999. Please provide an address.');
        });
