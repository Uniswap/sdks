...
describe('Claim Builders', () => {
    ...
    describe('SingleClaimBuilder', () => {
        ...
        it('should throw if sponsor is missing', () => {
            expect(() => ClaimBuilder.single(domain)
                .nonce(1n)
                .expires(BigInt(Date.now() + 3600000))
                .id(encodeLockId(lockTag, usdcAddress))
                .allocatedAmount(1000000n)
    ...
    describe('BatchClaimBuilder', () => {
        it('should build a batch claim with manual field setting', () => {
            ...
            const id2 = encodeLockId(lockTag, '0x6b175474e89094c44da98b954eedeac495271d0f');
        ...
        it('should throw if sponsor is missing', () => {
            expect(() => ClaimBuilder.batch(domain)
                .nonce(1n)
                .expires(BigInt(Date.now() + 3600000))
                .addClaim()
                .id(100n)
    ...
    describe('MultichainClaimBuilder', () => {
        ...
        it('should throw if sponsor is missing', () => {
            expect(() => ClaimBuilder.multichain(domain)
                .nonce(1n)
                .expires(BigInt(Date.now() + 3600000))
                .id(100n)
                .lockTag(lockTag)
    ...
    describe('BatchMultichainClaimBuilder', () => {
        it('should build a batch multichain claim with multiple resources', () => {
            ...
            const resourceId2 = encodeLockId('0x000000000000000000000002', usdcAddress);
        ...
        it('should throw if no claims are added', () => {
            expect(() => ClaimBuilder.batchMultichain(domain)
                .sponsor(sponsorAddress)
                .nonce(1n)
                .expires(BigInt(Date.now() + 3600000))
                .build()).toThrow('at least one claim component is required');
    ...
    describe('ExogenousMultichainClaimBuilder', () => {
        ...
        it('should throw if chainIndex is not set', () => {
            expect(() => ClaimBuilder.exogenousMultichain(domain)
                .sponsor(sponsorAddress)
                .nonce(1n)
                .expires(BigInt(Date.now() + 3600000))
                .id(encodeLockId(lockTag, usdcAddress))
    ...
    describe('ExogenousBatchMultichainClaimBuilder', () => {
        ...
        it('should throw if chainIndex is not set', () => {
            expect(() => ClaimBuilder.exogenousBatchMultichain(domain)
                .sponsor(sponsorAddress)
                .nonce(1n)
                .expires(BigInt(Date.now() + 3600000))
                .notarizedChainId(1n)
