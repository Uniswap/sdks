...
import { Scope } from '../types/runtime';
/**
 ...
 */
export function encodeLockTag(parts) {
 ...
 */
export function decodeLockTag(lockTag) {
 ...
 */
export function encodeLockId(lockTag, token) {
    // Validate inputs
 ...
 */
export function decodeLockId(id) {
