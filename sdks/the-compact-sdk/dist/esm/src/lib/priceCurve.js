 ...
 */
export function createPriceCurveElement(blockDuration, scalingFactor) {
 ...
 */
export function getBlockDuration(element) {
 ...
 */
export function getScalingFactor(element) {
 ...
 */
export function unpackPriceCurveElement(element) {
    return {
 ...
 */
export function sharesScalingDirection(a, b) {
 ...
 */
export function applySupplementalPriceCurve(baseCurve, supplementalCurve) {
    const combinedCurve = [];
 ...
 */
export function getCalculatedScalingFactor(curve, blocksPassed) {
 ...
 */
export function createPriceCurve(elements) {
 ...
 */
export function unpackPriceCurve(curve) {
