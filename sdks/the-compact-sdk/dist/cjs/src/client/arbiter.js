...
exports.ArbiterClient = void 0;
const tslib_1 = require("tslib");
const theCompact_1 = require("../abi/theCompact");
const claim_1 = require("../builders/claim");
const domain_1 = require("../config/domain");
const decode_1 = require("../errors/decode");
const hashes_1 = require("../encoding/hashes");
...
class ArbiterClient {
     ...
     */
    async claim(claim) {
        (0, tiny_invariant_1.default)(this.config.walletClient, 'walletClient is required for claims');
        ...
        try {
            ...
            const compactError = (0, decode_1.extractCompactError)(error, theCompact_1.theCompactAbi);
            if (compactError) {
                throw compactError;
            }
            throw error;
     ...
     * ```
     */
    async batchMultichainClaim(claim) {
        (0, tiny_invariant_1.default)(this.config.walletClient, 'walletClient is required for claims');
        (0, tiny_invariant_1.default)(this.config.address, 'contract address is required');
        try {
            const hash = await this.config.walletClient.writeContract({
    ...
    singleClaimBuilder() {
        ...
        return claim_1.ClaimBuilder.single(domain);
    }
    /**
    ...
    batchClaimBuilder() {
        ...
        return claim_1.ClaimBuilder.batch(domain);
    }
    /**
    ...
    multichainClaimBuilder() {
        ...
        return claim_1.ClaimBuilder.multichain(domain);
    }
    /**
    ...
    batchMultichainClaimBuilder() {
        ...
        return claim_1.ClaimBuilder.batchMultichain(domain);
    }
    /**
     ...
     * @throws {CompactError} If the claim is invalid or processing fails
     */
    async exogenousMultichainClaim(claim) {
        (0, tiny_invariant_1.default)(this.config.walletClient, 'walletClient is required for claims');
        (0, tiny_invariant_1.default)(this.config.address, 'contract address is required');
        try {
            const hash = await this.config.walletClient.writeContract({
     ...
     * @throws {CompactError} If the claim is invalid or processing fails
     */
    async exogenousBatchMultichainClaim(claim) {
        (0, tiny_invariant_1.default)(this.config.walletClient, 'walletClient is required for claims');
        (0, tiny_invariant_1.default)(this.config.address, 'contract address is required');
        try {
            const hash = await this.config.walletClient.writeContract({
    ...
    exogenousMultichainClaimBuilder() {
        ...
        return claim_1.ClaimBuilder.exogenousMultichain(domain);
    }
    /**
    ...
    exogenousBatchMultichainClaimBuilder() {
        ...
        return claim_1.ClaimBuilder.exogenousBatchMultichain(domain);
    }
}
exports.ArbiterClient = ArbiterClient;
