...
const compact_1 = require("../builders/compact");
...
class SponsorClient {
    ...
    async depositNative(params) {
        (0, tiny_invariant_1.default)(this.config.walletClient, 'walletClient is required for deposits');
    ...
    async register(params) {
        (0, tiny_invariant_1.default)(this.config.walletClient, 'walletClient is required for registration');
        (0, tiny_invariant_1.default)(this.config.address, 'contract address is required');
        try {
            const hash = await this.config.walletClient.writeContract({
                address: this.config.address,
     ...
     * ```
     */
    async enableForcedWithdrawal(id) {
        (0, tiny_invariant_1.default)(this.config.walletClient, 'walletClient is required');
        (0, tiny_invariant_1.default)(this.config.address, 'contract address is required');
        try {
            const hash = await this.config.walletClient.writeContract({
                address: this.config.address,
     ...
     * ```
     */
    async disableForcedWithdrawal(id) {
        (0, tiny_invariant_1.default)(this.config.walletClient, 'walletClient is required');
        (0, tiny_invariant_1.default)(this.config.address, 'contract address is required');
        try {
            const hash = await this.config.walletClient.writeContract({
     ...
     * ```
     */
    async forcedWithdrawal(id, recipient, amount) {
        (0, tiny_invariant_1.default)(this.config.walletClient, 'walletClient is required');
        (0, tiny_invariant_1.default)(this.config.address, 'contract address is required');
        try {
            const hash = await this.config.walletClient.writeContract({
    ...
    compact() {
        ...
        return compact_1.CompactBuilder.single(domain);
    }
    /**
    ...
    batchCompact() {
        ...
        return compact_1.CompactBuilder.batch(domain);
    }
    /**
    ...
    multichainCompact() {
        ...
        return compact_1.CompactBuilder.multichain(domain);
    }
}
