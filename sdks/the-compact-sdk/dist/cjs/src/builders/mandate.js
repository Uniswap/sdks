...
exports.TribunalMandate = exports.MandateFields = void 0;
    ...
    for (const field of fields) {
        ...
        if (isArray && isPrimitiveType(baseType)) {
            ...
            for (const item of fieldValue) {
                ...
                (0, tiny_invariant_1.default)(typeHash, `Type hash not found for ${baseType}`);
 ...
 * ```
 */
exports.TribunalMandate = defineMandateType({
    fields: [exports.MandateFields.address('adjuster'), { name: 'fills', type: 'Mandate_Fill[]' }],
    nestedTypes: {
        Mandate_Fill: [
            exports.MandateFields.uint256('chainId'),
            exports.MandateFields.address('tribunal'),
            exports.MandateFields.uint256('expires'),
            { name: 'components', type: 'Mandate_FillComponent[]' },
            exports.MandateFields.uint256('baselinePriorityFee'),
            exports.MandateFields.uint256('scalingFactor'),
            { name: 'priceCurve', type: 'uint256[]' },
            { name: 'recipientCallback', type: 'Mandate_RecipientCallback[]' },
            exports.MandateFields.bytes32('salt'),
        ],
        Mandate_FillComponent: [
            exports.MandateFields.address('fillToken'),
            exports.MandateFields.uint256('minimumFillAmount'),
            exports.MandateFields.address('recipient'),
            exports.MandateFields.bool('applyScaling'),
        ],
        Mandate_Lock: [
            { name: 'lockTag', type: 'bytes12' },
            exports.MandateFields.address('token'),
            exports.MandateFields.uint256('amount'),
        ],
        Mandate_BatchCompact: [
            exports.MandateFields.address('arbiter'),
            exports.MandateFields.address('sponsor'),
            exports.MandateFields.uint256('nonce'),
            exports.MandateFields.uint256('expires'),
        ...
        Mandate_RecipientCallback: [
            ...
            exports.MandateFields.bytes('context'),
        ],
    },
});
