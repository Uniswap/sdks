...
exports.TribunalBuilder = exports.MandateBuilder = exports.FillParametersBuilder = exports.FillComponentBuilder = void 0;
exports.createSameChainFill = createSameChainFill;
exports.createCrossChainFill = createCrossChainFill;
...
class FillComponentBuilder {
     ...
     */
    build() {
        (0, tiny_invariant_1.default)(this._fillToken, 'fillToken is required');
        (0, tiny_invariant_1.default)(this._minimumFillAmount !== undefined, 'minimumFillAmount is required');
        (0, tiny_invariant_1.default)(this._recipient, 'recipient is required');
        return {
...
class FillParametersBuilder {
     ...
     */
    priceCurve(elements) {
        this._priceCurve = (0, priceCurve_1.createPriceCurve)(elements);
        return this;
    }
    /**
    ...
    build() {
        ...
        (0, tiny_invariant_1.default)(this._tribunal, 'tribunal is required');
        (0, tiny_invariant_1.default)(this._expires !== undefined, 'expires is required');
        (0, tiny_invariant_1.default)(this._components.length > 0, 'at least one component is required');
        return {
...
exports.FillParametersBuilder = FillParametersBuilder;
/**
 * Builder for Mandate
...
class MandateBuilder {
     ...
     */
    build() {
        (0, tiny_invariant_1.default)(this._adjuster, 'adjuster is required');
        (0, tiny_invariant_1.default)(this._fills.length > 0, 'at least one fill is required');
        return {
...
exports.MandateBuilder = MandateBuilder;
/**
...
exports.TribunalBuilder = TribunalBuilder;
/**
 ...
 */
function createSameChainFill(params) {
 ...
 */
function createCrossChainFill(params) {
