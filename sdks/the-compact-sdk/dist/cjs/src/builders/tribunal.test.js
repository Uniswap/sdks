...
const tribunal_1 = require("./tribunal");
const priceCurve_1 = require("../lib/priceCurve");
describe('Tribunal Builders', () => {
    const tribunalAddress = '0x1234567890123456789012345678901234567890';
    const adjusterAddress = '0xabcdefabcdefabcdefabcdefabcdefabcdefabcd';
    ...
    describe('FillComponentBuilder', () => {
        it('should build a fill component', () => {
            const component = tribunal_1.TribunalBuilder.component()
        ...
        it('should throw if required fields are missing', () => {
            expect(() => tribunal_1.TribunalBuilder.component().build()).toThrow();
        });
    });
    describe('FillParametersBuilder', () => {
        it('should build fill parameters', () => {
            const fill = tribunal_1.TribunalBuilder.fill()
                .chainId(1n)
                ...
                .scalingFactor(priceCurve_1.SCALING_FACTOR.ONE_TWENTY_PERCENT)
                .priceCurve([{ blockDuration: 100, scalingFactor: priceCurve_1.SCALING_FACTOR.ONE_FIFTY_PERCENT }])
                .build();
            ...
            expect(fill.scalingFactor).toBe(priceCurve_1.SCALING_FACTOR.ONE_TWENTY_PERCENT);
        ...
        it('should allow adding multiple components', () => {
            const fill = tribunal_1.TribunalBuilder.fill()
                ...
                .component((c) => c.fillToken(usdcAddress).minimumFillAmount(1000000n).recipient(recipientAddress))
                .component((c) => c
                .fillToken('0x0000000000000000000000000000000000000000')
        ...
        it('should default to neutral scaling factor', () => {
            const fill = tribunal_1.TribunalBuilder.fill()
                ...
                .component((c) => c.fillToken(usdcAddress).minimumFillAmount(1000000n).recipient(recipientAddress))
                .build();
            expect(fill.scalingFactor).toBe(priceCurve_1.SCALING_FACTOR.NEUTRAL);
        });
    ...
    describe('MandateBuilder', () => {
        it('should build a mandate with fills', () => {
            const mandate = tribunal_1.TribunalBuilder.mandate()
        ...
        it('should throw if adjuster is not set', () => {
            expect(() => tribunal_1.TribunalBuilder.mandate().build()).toThrow();
        });
        it('should throw if no fills are added', () => {
            expect(() => tribunal_1.TribunalBuilder.mandate().adjuster(adjusterAddress).build()).toThrow();
        });
    });
    describe('convenience functions', () => {
        it('should create same-chain fill', () => {
            const fill = (0, tribunal_1.createSameChainFill)({
                chainId: 1n,
                tribunal: tribunalAddress,
                expires: BigInt(Date.now() + 3600000),
                fillToken: usdcAddress,
        ...
        it('should create cross-chain fill with callback', () => {
            ...
            const fill = (0, tribunal_1.createCrossChainFill)({
                sourceChainId: 1n,
                targetChainId: 137n,
    ...
    describe('complex mandate example', () => {
        it('should build a cross-chain swap mandate', () => {
            ...
            const mandate = tribunal_1.TribunalBuilder.mandate()
                ...
                .scalingFactor(priceCurve_1.SCALING_FACTOR.ONE_FIFTY_PERCENT)
                .priceCurve([
                { blockDuration: 30, scalingFactor: priceCurve_1.SCALING_FACTOR.ONE_FIFTY_PERCENT },
                { blockDuration: 40, scalingFactor: priceCurve_1.SCALING_FACTOR.ONE_TWENTY_PERCENT },
                ...
                .recipient(recipientAddress))
                .priceCurve([{ blockDuration: 100, scalingFactor: priceCurve_1.SCALING_FACTOR.NINETY_PERCENT }]))
                .build();
            expect(mandate.adjuster).toBe(adjusterAddress);
            expect(mandate.fills.length).toBe(2);
...
//# sourceMappingURL=tribunal.test.js.map