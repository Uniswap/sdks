 ...
 */
function buildComponent(lockTagOfClaim, claimant) {
    // Validate recipient address
    const recipientHex = claimant.recipient.slice(2).toLowerCase();
    (0, tiny_invariant_1.default)(recipientHex.length === 40, 'recipient must be a valid address');
    // Validate amount
    (0, tiny_invariant_1.default)(claimant.amount > 0n, 'amount must be positive');
    ...
    switch (claimant.kind) {
        ...
        case 'convert': {
            ...
            (0, tiny_invariant_1.default)(targetLockTagHex.length === 24, 'targetLockTag must be 12 bytes');
 ...
 */
function decodeComponent(component, lockTagOfClaim) {
