...
describe('locks encoding', () => {
    describe('encodeLockTag', () => {
        ...
        it('should throw for allocatorId that is too large', () => {
            expect(() => (0, locks_1.encodeLockTag)({
                allocatorId: 2n ** 96n,
                scope: runtime_1.Scope.ChainSpecific,
                resetPeriod: runtime_1.ResetPeriod.OneDay,
            })).toThrow();
    ...
    describe('decodeLockTag', () => {
        it('should decode a lock tag correctly', () => {
            ...
            const encoded = (0, locks_1.encodeLockTag)(original);
    ...
    describe('decodeLockId', () => {
        it('should decode a lock ID correctly', () => {
            ...
            const token = '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48';
            const id = (0, locks_1.encodeLockId)(lockTag, token);
            const decoded = (0, locks_1.decodeLockId)(id);
    ...
    describe('The Compact compatibility', () => {
        describe('allocator ID edge cases', () => {
            it('should handle allocator addresses with many leading zeros', () => {
                ...
                const allocator1 = '0x00000000000000171ede64904551eeDF3C6C9788';
                ...
                const decoded1 = (0, locks_1.decodeLockTag)(lockTag1);
            ...
            it('should handle allocator with no leading zeros', () => {
                ...
                const allocator = '0x8000000000000000000000000000000000000000';
        ...
        describe('lock ID roundtrip with various tokens', () => {
            it('should correctly encode/decode with well-known token addresses', () => {
                ...
                for (const token of wellKnownTokens) {
                    ...
                    const lockId = (0, locks_1.encodeLockId)(lockTag, tokenAddress);
        ...
        describe('edge values', () => {
            it('should handle maximum allocatorId value', () => {
                ...
                expect(decoded.scope).toBe(runtime_1.Scope.Multichain);
                expect(decoded.resetPeriod).toBe(runtime_1.ResetPeriod.ThirtyDays);
            });
