...
describe('hash computation', () => {
    ...
    describe('componentsHash', () => {
        ...
        it('should hash single component', () => {
            ...
            const amount = 100n;
            const components = [{ claimant, amount }];
            const hash = (0, hashes_1.componentsHash)(components);
        ...
        it('should hash multiple components', () => {
            ...
            const hash1 = (0, viem_1.keccak256)((0, viem_1.encodeAbiParameters)([
                { name: 'claimant', type: 'uint256' },
                { name: 'amount', type: 'uint256' },
            ], [components[0].claimant, components[0].amount]));
            const hash2 = (0, viem_1.keccak256)((0, viem_1.encodeAbiParameters)([
                { name: 'claimant', type: 'uint256' },
                { name: 'amount', type: 'uint256' },
            ], [components[1].claimant, components[1].amount]));
            const hash3 = (0, viem_1.keccak256)((0, viem_1.encodeAbiParameters)([
                { name: 'claimant', type: 'uint256' },
                { name: 'amount', type: 'uint256' },
    ...
    describe('idsAndAmountsHash', () => {
        ...
        it('should handle multiple well-known tokens (from ClaimHashLib.t.sol)', () => {
            ...
            const hashes = idsAndAmounts.map((pair) => (0, viem_1.keccak256)((0, viem_1.encodeAbiParameters)([
                { name: 'id', type: 'uint256' },
                { name: 'amount', type: 'uint256' },
            ], [pair.id, pair.amount])));
    ...
    describe('edge cases', () => {
        it('should handle maximum uint256 values', () => {
            ...
            const components = [{ claimant: maxUint256, amount: maxUint256 }];
            const hash = (0, hashes_1.componentsHash)(components);
            // Should not throw and should produce valid hash
            expect(hash).toMatch(/^0x[0-9a-f]{64}$/);
        });
        it('should handle zero values', () => {
            const components = [{ claimant: 0n, amount: 0n }];
            const hash = (0, hashes_1.componentsHash)(components);
            const componentHash = (0, viem_1.keccak256)((0, viem_1.encodeAbiParameters)([
                { name: 'claimant', type: 'uint256' },
                { name: 'amount', type: 'uint256' },
    ...
    describe('hash consistency', () => {
        it('should produce consistent hashes for identical inputs', () => {
            const components = [{ claimant: 0xabcdef123456n, amount: 999n }];
        ...
        it('should produce different hashes for different inputs', () => {
            const components1 = [{ claimant: 100n, amount: 200n }];
            const components2 = [
    ...
    describe('compatibility with Solidity implementation', () => {
        ...
        it('should match lock hash structure from The Compact', () => {
            ...
            const lockTypehash = (0, viem_1.keccak256)('0xfb7744571d97aa61eb9c2bc3c67b9b1ba047ac9e95afb2ef02bc5b3d9e64fbe5');
