...
exports.ResetPeriod = exports.Scope = exports.CompactCategory = void 0;
exports.resetPeriodToSeconds = resetPeriodToSeconds;
exports.secondsToResetPeriod = secondsToResetPeriod;
/**
...
})(CompactCategory || (exports.CompactCategory = CompactCategory = {}));
/**
 ...
 */
function resetPeriodToSeconds(resetPeriod) {
    switch (resetPeriod) {
 ...
 */
function secondsToResetPeriod(seconds) {
    if (seconds <= 1n)
