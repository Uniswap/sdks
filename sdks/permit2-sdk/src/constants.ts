...
port function permit2Address(chainId?: number): string {
  switch (chainId) {
    case 324:
...
port const MaxAllowanceTransferAmount = MaxUint160
xport const MaxAllowanceExpiration = MaxUint48
port const MaxOrderedNonce = MaxUint48
