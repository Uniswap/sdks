...
describe('BatchedCallPlanner', () => {
  ...
  describe('add', () => {
    ...
    it('should allow chaining multiple add calls', () => {
      ...
      batchedPlanner.add(TEST_ADDRESS_1, TEST_VALUE_1, TEST_DATA_1).add(TEST_ADDRESS_1, TEST_VALUE_2, TEST_DATA_2)
  ...
  describe('encode', () => {
    ...
    it('should encode multiple calls correctly', () => {
      const callPlanner = new CallPlanner()
      callPlanner.add(TEST_ADDRESS_1, TEST_VALUE_1, TEST_DATA_1).add(TEST_ADDRESS_1, TEST_VALUE_2, TEST_DATA_2)
