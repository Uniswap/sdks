 ...
 */
function validateHex(value: string, expectedLength: number, fieldName: string): void {
 ...
 */
export function validateWorkloadMeasurementRegisters(registers: WorkloadMeasurementRegisters): void {
 ...
 */
export function validateSingularWorkloadMeasurementRegisters(registers: SingularWorkloadMeasurementRegisters): void {
