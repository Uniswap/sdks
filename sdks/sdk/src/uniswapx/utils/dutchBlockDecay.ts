...
*/
function locateArrayPosition(curve: NonlinearDutchDecay, currentRelativeBlock: number): [number, number] {
...
export function getBlockDecayedAmount(config: DutchBlockDecayConfig, atBlock: number): BigNumber {
...
export function getEndAmount(config: Partial<DutchBlockDecayConfig>): BigNumber {
