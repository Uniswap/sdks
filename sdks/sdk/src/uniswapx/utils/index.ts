import { OrderType, PERMIT2_MAPPING, REACTOR_ADDRESS_MAPPING } from '../constants'
...
export function getReactor(chainId: number, orderType: OrderType, reactorAddress?: string): string {
