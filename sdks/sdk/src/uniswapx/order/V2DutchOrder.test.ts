...
describe('V2DutchOrder', () => {
  const getFullOrderInfo = (data: Partial<CosignedV2DutchOrderInfo>): CosignedV2DutchOrderInfo => {
  ...
  const getOrderInfo = (data: Partial<UnsignedV2DutchOrderInfo>): UnsignedV2DutchOrderInfo => {
    return Object.assign(
      {
        deadline: NOW + 1000,
        reactor: ethers.constants.AddressZero,
