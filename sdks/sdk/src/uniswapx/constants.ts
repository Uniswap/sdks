...
export function constructSameAddressMap<T>(address: T, additionalNetworks: ChainId[] = []): { [chainId: number]: T } {
...
export const REVERSE_RESOLVER_MAPPING: ReverseResolverMapping = Object.entries(HYBRID_RESOLVER_ADDRESS_MAPPING).reduce(
  (acc: ReverseResolverMapping, [, resolverAddress]) => {
