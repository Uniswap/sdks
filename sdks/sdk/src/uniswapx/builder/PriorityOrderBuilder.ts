...
export class PriorityOrderBuilder extends OrderBuilder {
  ...
  buildPartial(): UnsignedPriorityOrder {
    ...
    invariant(
      this.info.auctionStartBlock !== undefined && this.info.auctionStartBlock.gt(0),
  ...
  build(): CosignedPriorityOrder {
    ...
    invariant(
      this.info.cosignerData !== undefined &&
        ...
        this.info.cosignerData.auctionTargetBlock.lte(this.info.auctionStartBlock),
...
function isCosigned(order: UnsignedPriorityOrder | CosignedPriorityOrder): order is CosignedPriorityOrder {
