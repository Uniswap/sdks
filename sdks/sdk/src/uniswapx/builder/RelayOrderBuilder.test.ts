...
describe('RelayOrderBuilder', () => {
  ...
  it('Regenerates builder allows modification', () => {
    ...
    const regenerated = RelayOrderBuilder.fromOrder(order).universalRouterCalldata('new action').build()
  ...
  it('feeEndTime after deadline', () => {
    ...
    expect(() =>
      builder
        ...
        .universalRouterCalldata('0x')
        .build()
    ).toThrow(`Invariant failed: feeEndTime must be before or same as deadline: ${deadline + 1}`)
  })
