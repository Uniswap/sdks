...
var CallPlanner = class {
  ...
  encode() {
    ...
    return viem.encodeAbiParameters(CALL_ABI_PARAMS, [this.calls]);
  }
  /**
...
var BatchedCallPlanner = class {
   ...
   */
  encode() {
    return viem.encodeAbiParameters(BATCHED_CALL_ABI_PARAMS, [
      {
...
exports.CALL_ABI_PARAMS = CALL_ABI_PARAMS;
exports.CallPlanner = CallPlanner;
exports.DELEGATION_MAGIC_PREFIX = DELEGATION_MAGIC_PREFIX;
exports.ModeType = ModeType;
exports.SELF_CALL_TARGET = SELF_CALL_TARGET;
exports.SMART_WALLET_ADDRESSES = SMART_WALLET_ADDRESSES;
exports.SMART_WALLET_VERSIONS = SMART_WALLET_VERSIONS;
exports.SmartWallet = SmartWallet;
exports.SmartWalletVersion = SmartWalletVersion;
