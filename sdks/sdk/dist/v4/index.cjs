...
var invariant15 = require('tiny-invariant');
...
var invariant15__default = /*#__PURE__*/_interopDefault(invariant15);
...
var Fraction = class _Fraction {
  ...
  toSignificant(significantDigits, format = { groupSeparator: "" }, rounding = 1 /* ROUND_HALF_UP */) {
    invariant15__default.default(Number.isInteger(significantDigits), `${significantDigits} is not an integer.`);
    invariant15__default.default(significantDigits > 0, `${significantDigits} is not positive.`);
    Decimal.set({ precision: significantDigits + 1, rounding: toSignificantRounding[rounding] });
    const quotient = new Decimal(this.numerator.toString()).div(this.denominator.toString()).toSignificantDigits(significantDigits);
    return quotient.toFormat(quotient.decimalPlaces(), format);
  }
  toFixed(decimalPlaces, format = { groupSeparator: "" }, rounding = 1 /* ROUND_HALF_UP */) {
    invariant15__default.default(Number.isInteger(decimalPlaces), `${decimalPlaces} is not an integer.`);
    invariant15__default.default(decimalPlaces >= 0, `${decimalPlaces} is negative.`);
...
var CurrencyAmount = class _CurrencyAmount extends Fraction {
  ...
  constructor(currency, numerator, denominator) {
    ...
    invariant15__default.default(JSBI13__default.default.lessThanOrEqual(this.quotient, MaxUint256), "AMOUNT");
  ...
  add(other) {
    invariant15__default.default(this.currency.equals(other.currency), "CURRENCY");
  ...
  toFixed(decimalPlaces = this.currency.decimals, format, rounding = 0 /* ROUND_DOWN */) {
    invariant15__default.default(decimalPlaces <= this.currency.decimals, "DECIMALS");
...
var Price = class _Price extends Fraction {
   ...
   */
  multiply(other) {
    invariant15__default.default(this.quoteCurrency.equals(other.baseCurrency), "TOKEN");
  ...
  quote(currencyAmount) {
    invariant15__default.default(currencyAmount.currency.equals(this.baseCurrency), "TOKEN");
...
function sortedInsert(items, add, maxSize, comparator) {
  invariant15__default.default(maxSize > 0, "MAX_SIZE_ZERO");
  invariant15__default.default(items.length <= maxSize, "ITEMS_SIZE");
  if (items.length === 0) {
    items.push(add);
    return null;
  } else {
...
function sqrt(value) {
  invariant15__default.default(JSBI13__default.default.greaterThanOrEqual(value, ZERO), "NEGATIVE");
...
JSBI13__default.default.exponentiate(Q96, JSBI13__default.default.BigInt(2));
var FullMath = class {
  /**
...
var SqrtPriceMath = class {
  ...
  static getNextSqrtPriceFromInput(sqrtPX96, liquidity, amountIn, zeroForOne) {
    invariant15__default.default(JSBI13__default.default.greaterThan(sqrtPX96, ZERO2));
    invariant15__default.default(JSBI13__default.default.greaterThan(liquidity, ZERO2));
  ...
  static getNextSqrtPriceFromAmount0RoundingUp(sqrtPX96, liquidity, amount, add) {
    ...
    if (add) {
      ...
      let product = multiplyIn256(amount, sqrtPX96);
      invariant15__default.default(JSBI13__default.default.equal(JSBI13__default.default.divide(product, amount), sqrtPX96));
      invariant15__default.default(JSBI13__default.default.greaterThan(numerator1, product));
  ...
  static getNextSqrtPriceFromAmount1RoundingDown(sqrtPX96, liquidity, amount, add) {
    if (add) {
      ...
      invariant15__default.default(JSBI13__default.default.greaterThan(sqrtPX96, quotient));
...
function mostSignificantBit(x) {
  invariant15__default.default(JSBI13__default.default.greaterThan(x, ZERO2), "ZERO");
  invariant15__default.default(JSBI13__default.default.lessThanOrEqual(x, MaxUint256), "MAX");
  let msb = 0;
...
var _TickMath = class _TickMath {
  ...
  static getSqrtRatioAtTick(tick) {
    invariant15__default.default(tick >= _TickMath.MIN_TICK && tick <= _TickMath.MAX_TICK && Number.isInteger(tick), "TICK");
...
async function v3Swap(fee, sqrtRatioX96, tickCurrent, liquidity, tickSpacing, tickDataProvider, zeroForOne, amountSpecified, sqrtPriceLimitX96) {
  ...
  if (zeroForOne) {
    invariant15__default.default(JSBI13__default.default.greaterThan(sqrtPriceLimitX96, TickMath.MIN_SQRT_RATIO), "RATIO_MIN");
    invariant15__default.default(JSBI13__default.default.lessThan(sqrtPriceLimitX96, sqrtRatioX96), "RATIO_CURRENT");
  } else {
    invariant15__default.default(JSBI13__default.default.lessThan(sqrtPriceLimitX96, TickMath.MAX_SQRT_RATIO), "RATIO_MAX");
    invariant15__default.default(JSBI13__default.default.greaterThan(sqrtPriceLimitX96, sqrtRatioX96), "RATIO_CURRENT");
  }
...
var TickList = class _TickList {
  ...
  static validateList(ticks, tickSpacing) {
    invariant15__default.default(tickSpacing > 0, "TICK_SPACING_NONZERO");
    invariant15__default.default(
    ...
    invariant15__default.default(isSorted(ticks, tickComparator), "SORTED");
  }
  static isBelowSmallest(ticks, tick) {
    invariant15__default.default(ticks.length > 0, "LENGTH");
  ...
  static getTick(ticks, index) {
    ...
    invariant15__default.default(tick.index === index, "NOT_CONTAINED");
    return tick;
  }
  /**
  ...
  static binarySearch(ticks, tick) {
    invariant15__default.default(!this.isBelowSmallest(ticks, tick), "BELOW_SMALLEST");
    let l = 0;
  ...
  static nextInitializedTick(ticks, tick, lte) {
    if (lte) {
      invariant15__default.default(!_TickList.isBelowSmallest(ticks, tick), "BELOW_SMALLEST");
      ...
      invariant15__default.default(!this.isAtOrAboveLargest(ticks, tick), "AT_OR_ABOVE_LARGEST");
...
var Tick = class {
  constructor({ index, liquidityGross, liquidityNet }) {
    invariant15__default.default(index >= TickMath.MIN_TICK && index <= TickMath.MAX_TICK, "TICK");
    this.index = index;
...
var Hook = class _Hook {
  ...
  static _checkAddress(address) {
    invariant15__default.default(utils.isAddress(address), "invalid address");
  }
};
...
var Pool = class _Pool {
  static getPoolKey(currencyA, currencyB, fee, tickSpacing, hooks) {
    invariant15__default.default(utils.isAddress(hooks), "Invalid hook address");
  ...
  constructor(currencyA, currencyB, fee, tickSpacing, hooks, sqrtRatioX96, liquidity, tickCurrent, ticks = NO_TICK_DATA_PROVIDER_DEFAULT) {
    invariant15__default.default(utils.isAddress(hooks), "Invalid hook address");
    invariant15__default.default(Number.isInteger(fee) && (fee === DYNAMIC_FEE_FLAG || fee < 1e6), "FEE");
    if (fee === DYNAMIC_FEE_FLAG) {
      invariant15__default.default(Number(hooks) > 0, "Dynamic fee pool requires a hook");
    }
   ...
   */
  priceOf(currency) {
    invariant15__default.default(this.involvesCurrency(currency), "CURRENCY");
  ...
  async getOutputAmount(inputAmount, sqrtPriceLimitX96) {
    invariant15__default.default(this.involvesCurrency(inputAmount.currency), "CURRENCY");
  ...
  async getInputAmount(outputAmount, sqrtPriceLimitX96) {
    invariant15__default.default(this.involvesCurrency(outputAmount.currency), "CURRENCY");
...
var Route = class {
  ...
  constructor(pools, input, output) {
    ...
    this._midPrice = null;
    invariant15__default.default(pools.length > 0, "POOLS");
    const chainId = pools[0].chainId;
    const allOnSameChain = pools.every((pool) => pool.chainId === chainId);
    invariant15__default.default(allOnSameChain, "CHAIN_IDS");
    ...
    for (const [i, pool] of pools.entries()) {
      ...
      invariant15__default.default(currentInputCurrency.equals(pool.currency0) || currentInputCurrency.equals(pool.currency1), "PATH");
...
function tradeComparator(a, b) {
  invariant15__default.default(a.inputAmount.currency.equals(b.inputAmount.currency), "INPUT_CURRENCY");
  invariant15__default.default(a.outputAmount.currency.equals(b.outputAmount.currency), "OUTPUT_CURRENCY");
...
var Trade = class _Trade {
   ...
   */
  get route() {
    invariant15__default.default(this.swaps.length === 1, "MULTIPLE_ROUTES");
  ...
  static async fromRoute(route, amount, tradeType) {
    ...
    if (tradeType === 0 /* EXACT_INPUT */) {
      invariant15__default.default(amount.currency.equals(route.input), "INPUT");
      ...
      invariant15__default.default(amount.currency.equals(route.output), "OUTPUT");
  ...
  constructor({
    ...
    invariant15__default.default(numPools === poolIDSet.size, "POOLS_DUPLICATED");
    this.swaps = routes;
  ...
  minimumAmountOut(slippageTolerance, amountOut = this.outputAmount) {
    invariant15__default.default(!slippageTolerance.lessThan(ZERO3), "SLIPPAGE_TOLERANCE");
  ...
  static async bestTradeExactIn(pools, currencyAmountIn, currencyOut, { maxNumResults = 3, maxHops = 3 } = {}, currentPools = [], nextAmountIn = currencyAmountIn, bestTrades = []) {
    invariant15__default.default(pools.length > 0, "POOLS");
    invariant15__default.default(maxHops > 0, "MAX_HOPS");
    invariant15__default.default(currencyAmountIn === nextAmountIn || currentPools.length > 0, "INVALID_RECURSION");
  ...
  static async bestTradeExactOut(pools, currencyIn, currencyAmountOut, { maxNumResults = 3, maxHops = 3 } = {}, currentPools = [], nextAmountOut = currencyAmountOut, bestTrades = []) {
    invariant15__default.default(pools.length > 0, "POOLS");
    invariant15__default.default(maxHops > 0, "MAX_HOPS");
    invariant15__default.default(currencyAmountOut === nextAmountOut || currentPools.length > 0, "INVALID_RECURSION");
...
var Position = class _Position {
  ...
  constructor({ pool, liquidity, tickLower, tickUpper }) {
    ...
    invariant15__default.default(tickLower < tickUpper, "TICK_ORDER");
    invariant15__default.default(tickLower >= TickMath.MIN_TICK && tickLower % pool.tickSpacing === 0, "TICK_LOWER");
    invariant15__default.default(tickUpper <= TickMath.MAX_TICK && tickUpper % pool.tickSpacing === 0, "TICK_UPPER");
    this.pool = pool;
...
var V4Planner = class {
  ...
  addTrade(trade, slippageTolerance) {
    ...
    if (exactOutput) invariant15__default.default(!!slippageTolerance, "ExactOut requires slippageTolerance");
    invariant15__default.default(trade.swaps.length === 1, "Only accepts Trades with 1 swap (must break swaps into individual trades)");
...
function shouldCreatePool(options) {
  if (options.createPool) {
    invariant15__default.default(options.sqrtPriceX96 !== void 0, NO_SQRT_PRICE);
    return true;
  }
  return false;
}
var _V4PositionManager = class _V4PositionManager {
  ...
  static addCallParameters(position, options) {
    invariant15__default.default(JSBI13__default.default.greaterThan(position.liquidity, ZERO3), ZERO_LIQUIDITY);
    const calldataList = [];
  ...
  static removeCallParameters(position, options) {
    ...
    if (options.burnToken) {
      invariant15__default.default(options.liquidityPercentage.equalTo(ONE3), CANNOT_BURN);
      if (options.permit) {
        calldataList.push(
      ...
      invariant15__default.default(JSBI13__default.default.greaterThan(partialPosition.liquidity, ZERO3), ZERO_LIQUIDITY);
