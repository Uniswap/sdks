...
var JSBI14 = require('jsbi');
var invariant18 = require('tiny-invariant');
...
var IApproveAndCall = require('@uniswap/swap-router-contracts/artifacts/contracts/interfaces/IApproveAndCall.sol/IApproveAndCall.json');
...
var IMulticallExtended = require('@uniswap/swap-router-contracts/artifacts/contracts/interfaces/IMulticallExtended.sol/IMulticallExtended.json');
var IPeripheryPaymentsWithFeeExtended = require('@uniswap/swap-router-contracts/artifacts/contracts/interfaces/IPeripheryPaymentsWithFeeExtended.sol/IPeripheryPaymentsWithFeeExtended.json');
var ISwapRouter02 = require('@uniswap/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json');
var utils = require('ethers/lib/utils');
var ethers = require('ethers');

function _interopDefault (e) { return e && e.__esModule ? e : { default: e }; }

var JSBI14__default = /*#__PURE__*/_interopDefault(JSBI14);
var invariant18__default = /*#__PURE__*/_interopDefault(invariant18);
...
var IApproveAndCall__default = /*#__PURE__*/_interopDefault(IApproveAndCall);
...
var IMulticallExtended__default = /*#__PURE__*/_interopDefault(IMulticallExtended);
var IPeripheryPaymentsWithFeeExtended__default = /*#__PURE__*/_interopDefault(IPeripheryPaymentsWithFeeExtended);
var ISwapRouter02__default = /*#__PURE__*/_interopDefault(ISwapRouter02);
...
var MaxUint256 = JSBI14__default.default.BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
var RoundingMode = {
  RoundDown: 0,
  RoundHalfUp: 1,
  RoundUp: 3
...
var Fraction = class _Fraction {
  constructor(numerator, denominator = JSBI14__default.default.BigInt(1)) {
    this.numerator = JSBI14__default.default.BigInt(numerator);
    this.denominator = JSBI14__default.default.BigInt(denominator);
  }
  static tryParseFraction(fractionish) {
    if (fractionish instanceof JSBI14__default.default || typeof fractionish === "number" || typeof fractionish === "string")
  ...
  get quotient() {
    return JSBI14__default.default.divide(this.numerator, this.denominator);
  }
  // remainder after floor division
  get remainder() {
    return new _Fraction(JSBI14__default.default.remainder(this.numerator, this.denominator), this.denominator);
  }
  invert() {
  ...
  add(other) {
    ...
    if (JSBI14__default.default.equal(this.denominator, otherParsed.denominator)) {
      return new _Fraction(JSBI14__default.default.add(this.numerator, otherParsed.numerator), this.denominator);
    }
    return new _Fraction(
      JSBI14__default.default.add(
        JSBI14__default.default.multiply(this.numerator, otherParsed.denominator),
        JSBI14__default.default.multiply(otherParsed.numerator, this.denominator)
      ),
      JSBI14__default.default.multiply(this.denominator, otherParsed.denominator)
    );
  }
  subtract(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    if (JSBI14__default.default.equal(this.denominator, otherParsed.denominator)) {
      return new _Fraction(JSBI14__default.default.subtract(this.numerator, otherParsed.numerator), this.denominator);
    }
    return new _Fraction(
      JSBI14__default.default.subtract(
        JSBI14__default.default.multiply(this.numerator, otherParsed.denominator),
        JSBI14__default.default.multiply(otherParsed.numerator, this.denominator)
      ),
      JSBI14__default.default.multiply(this.denominator, otherParsed.denominator)
  ...
  lessThan(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    return JSBI14__default.default.lessThan(
      JSBI14__default.default.multiply(this.numerator, otherParsed.denominator),
      JSBI14__default.default.multiply(otherParsed.numerator, this.denominator)
    );
  }
  equalTo(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    return JSBI14__default.default.equal(
      JSBI14__default.default.multiply(this.numerator, otherParsed.denominator),
      JSBI14__default.default.multiply(otherParsed.numerator, this.denominator)
    );
  }
  greaterThan(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    return JSBI14__default.default.greaterThan(
      JSBI14__default.default.multiply(this.numerator, otherParsed.denominator),
      JSBI14__default.default.multiply(otherParsed.numerator, this.denominator)
    );
  }
  multiply(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    return new _Fraction(
      JSBI14__default.default.multiply(this.numerator, otherParsed.numerator),
      JSBI14__default.default.multiply(this.denominator, otherParsed.denominator)
    );
  }
  divide(other) {
    ...
    return new _Fraction(
      JSBI14__default.default.multiply(this.numerator, otherParsed.denominator),
      JSBI14__default.default.multiply(this.denominator, otherParsed.numerator)
    );
  }
  toSignificant(significantDigits, format = { groupSeparator: "" }, rounding = 1 /* ROUND_HALF_UP */) {
    invariant18__default.default(Number.isInteger(significantDigits), `${significantDigits} is not an integer.`);
    invariant18__default.default(significantDigits > 0, `${significantDigits} is not positive.`);
    Decimal.set({ precision: significantDigits + 1, rounding: toSignificantRounding[rounding] });
    const quotient = new Decimal(this.numerator.toString()).div(this.denominator.toString()).toSignificantDigits(significantDigits);
    return quotient.toFormat(quotient.decimalPlaces(), format);
  }
  toFixed(decimalPlaces, format = { groupSeparator: "" }, rounding = 1 /* ROUND_HALF_UP */) {
    invariant18__default.default(Number.isInteger(decimalPlaces), `${decimalPlaces} is not an integer.`);
    invariant18__default.default(decimalPlaces >= 0, `${decimalPlaces} is negative.`);
...
var CurrencyAmount = class _CurrencyAmount extends Fraction {
  ...
  constructor(currency, numerator, denominator) {
    ...
    invariant18__default.default(JSBI14__default.default.lessThanOrEqual(this.quotient, MaxUint256), "AMOUNT");
    this.currency = currency;
    this.decimalScale = JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(10), JSBI14__default.default.BigInt(currency.decimals));
  }
  add(other) {
    invariant18__default.default(this.currency.equals(other.currency), "CURRENCY");
  ...
  toFixed(decimalPlaces = this.currency.decimals, format, rounding = 0 /* ROUND_DOWN */) {
    invariant18__default.default(decimalPlaces <= this.currency.decimals, "DECIMALS");
...
var ONE_HUNDRED = new Fraction(JSBI14__default.default.BigInt(100));
...
var Price = class _Price extends Fraction {
  ...
  constructor(...args) {
    ...
    this.scalar = new Fraction(
      JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(10), JSBI14__default.default.BigInt(baseCurrency.decimals)),
      JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(10), JSBI14__default.default.BigInt(quoteCurrency.decimals))
    );
  }
  /**
   ...
   */
  multiply(other) {
    invariant18__default.default(this.quoteCurrency.equals(other.baseCurrency), "TOKEN");
  ...
  quote(currencyAmount) {
    invariant18__default.default(currencyAmount.currency.equals(this.baseCurrency), "TOKEN");
...
var BaseCurrency = class {
  ...
  constructor(chainId, decimals, symbol, name) {
    invariant18__default.default(Number.isSafeInteger(chainId), "CHAIN_ID");
    invariant18__default.default(decimals >= 0 && decimals < 255 && Number.isInteger(decimals), "DECIMALS");
...
var Token = class extends BaseCurrency {
  ...
  constructor(chainId, address, decimals, symbol, name, bypassChecksum, buyFeeBps, sellFeeBps) {
    ...
    if (buyFeeBps) {
      invariant18__default.default(buyFeeBps.gte(BigNumber.from(0)), "NON-NEGATIVE FOT FEES");
    }
    if (sellFeeBps) {
      invariant18__default.default(sellFeeBps.gte(BigNumber.from(0)), "NON-NEGATIVE FOT FEES");
    }
   ...
   */
  sortsBefore(other) {
    invariant18__default.default(this.chainId === other.chainId, "CHAIN_IDS");
    invariant18__default.default(this.address.toLowerCase() !== other.address.toLowerCase(), "ADDRESSES");
...
var _Ether = class _Ether extends NativeCurrency {
  ...
  get wrapped() {
    ...
    invariant18__default.default(!!weth9, "WRAPPED");
    return weth9;
  }
...
function sortedInsert(items, add, maxSize, comparator) {
  invariant18__default.default(maxSize > 0, "MAX_SIZE_ZERO");
  invariant18__default.default(items.length <= maxSize, "ITEMS_SIZE");
  if (items.length === 0) {
    items.push(add);
    return null;
  } else {
...
var MAX_SAFE_INTEGER = JSBI14__default.default.BigInt(Number.MAX_SAFE_INTEGER);
var ZERO = JSBI14__default.default.BigInt(0);
var ONE = JSBI14__default.default.BigInt(1);
var TWO = JSBI14__default.default.BigInt(2);
function sqrt(value) {
  invariant18__default.default(JSBI14__default.default.greaterThanOrEqual(value, ZERO), "NEGATIVE");
  if (JSBI14__default.default.lessThan(value, MAX_SAFE_INTEGER)) {
    return JSBI14__default.default.BigInt(Math.floor(Math.sqrt(JSBI14__default.default.toNumber(value))));
  }
  let z;
  let x;
  z = value;
  x = JSBI14__default.default.add(JSBI14__default.default.divide(value, TWO), ONE);
  while (JSBI14__default.default.lessThan(x, z)) {
    z = x;
    x = JSBI14__default.default.divide(JSBI14__default.default.add(JSBI14__default.default.divide(value, x), x), TWO);
  }
  return z;
}
...
var ZERO2 = JSBI14__default.default.BigInt(0);
var ONE2 = JSBI14__default.default.BigInt(1);
...
var NEGATIVE_ONE = JSBI14__default.default.BigInt(-1);
var ZERO3 = JSBI14__default.default.BigInt(0);
var ONE3 = JSBI14__default.default.BigInt(1);
var Q96 = JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(2), JSBI14__default.default.BigInt(96));
var Q192 = JSBI14__default.default.exponentiate(Q96, JSBI14__default.default.BigInt(2));
...
var FullMath = class {
  ...
  static mulDivRoundingUp(a, b, denominator) {
    const product = JSBI14__default.default.multiply(a, b);
    let result = JSBI14__default.default.divide(product, denominator);
    if (JSBI14__default.default.notEqual(JSBI14__default.default.remainder(product, denominator), ZERO3)) result = JSBI14__default.default.add(result, ONE3);
    return result;
  }
};
var MaxUint160 = JSBI14__default.default.subtract(JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(2), JSBI14__default.default.BigInt(160)), ONE3);
function multiplyIn256(x, y) {
  const product = JSBI14__default.default.multiply(x, y);
  return JSBI14__default.default.bitwiseAnd(product, MaxUint256);
}
function addIn256(x, y) {
  const sum = JSBI14__default.default.add(x, y);
  return JSBI14__default.default.bitwiseAnd(sum, MaxUint256);
}
var SqrtPriceMath = class {
  ...
  static getAmount0Delta(sqrtRatioAX96, sqrtRatioBX96, liquidity, roundUp) {
    if (JSBI14__default.default.greaterThan(sqrtRatioAX96, sqrtRatioBX96)) {
      [sqrtRatioAX96, sqrtRatioBX96] = [sqrtRatioBX96, sqrtRatioAX96];
    }
    const numerator1 = JSBI14__default.default.leftShift(liquidity, JSBI14__default.default.BigInt(96));
    const numerator2 = JSBI14__default.default.subtract(sqrtRatioBX96, sqrtRatioAX96);
    return roundUp ? FullMath.mulDivRoundingUp(FullMath.mulDivRoundingUp(numerator1, numerator2, sqrtRatioBX96), ONE3, sqrtRatioAX96) : JSBI14__default.default.divide(JSBI14__default.default.divide(JSBI14__default.default.multiply(numerator1, numerator2), sqrtRatioBX96), sqrtRatioAX96);
  }
  static getAmount1Delta(sqrtRatioAX96, sqrtRatioBX96, liquidity, roundUp) {
    if (JSBI14__default.default.greaterThan(sqrtRatioAX96, sqrtRatioBX96)) {
      [sqrtRatioAX96, sqrtRatioBX96] = [sqrtRatioBX96, sqrtRatioAX96];
    }
    return roundUp ? FullMath.mulDivRoundingUp(liquidity, JSBI14__default.default.subtract(sqrtRatioBX96, sqrtRatioAX96), Q96) : JSBI14__default.default.divide(JSBI14__default.default.multiply(liquidity, JSBI14__default.default.subtract(sqrtRatioBX96, sqrtRatioAX96)), Q96);
  }
  static getNextSqrtPriceFromInput(sqrtPX96, liquidity, amountIn, zeroForOne) {
    invariant18__default.default(JSBI14__default.default.greaterThan(sqrtPX96, ZERO3));
    invariant18__default.default(JSBI14__default.default.greaterThan(liquidity, ZERO3));
  ...
  static getNextSqrtPriceFromAmount0RoundingUp(sqrtPX96, liquidity, amount, add) {
    if (JSBI14__default.default.equal(amount, ZERO3)) return sqrtPX96;
    const numerator1 = JSBI14__default.default.leftShift(liquidity, JSBI14__default.default.BigInt(96));
    if (add) {
      let product = multiplyIn256(amount, sqrtPX96);
      if (JSBI14__default.default.equal(JSBI14__default.default.divide(product, amount), sqrtPX96)) {
        const denominator = addIn256(numerator1, product);
        if (JSBI14__default.default.greaterThanOrEqual(denominator, numerator1)) {
          return FullMath.mulDivRoundingUp(numerator1, sqrtPX96, denominator);
        }
      }
      return FullMath.mulDivRoundingUp(numerator1, ONE3, JSBI14__default.default.add(JSBI14__default.default.divide(numerator1, sqrtPX96), amount));
    } else {
      let product = multiplyIn256(amount, sqrtPX96);
      invariant18__default.default(JSBI14__default.default.equal(JSBI14__default.default.divide(product, amount), sqrtPX96));
      invariant18__default.default(JSBI14__default.default.greaterThan(numerator1, product));
      const denominator = JSBI14__default.default.subtract(numerator1, product);
      return FullMath.mulDivRoundingUp(numerator1, sqrtPX96, denominator);
    }
  }
  static getNextSqrtPriceFromAmount1RoundingDown(sqrtPX96, liquidity, amount, add) {
    if (add) {
      const quotient = JSBI14__default.default.lessThanOrEqual(amount, MaxUint160) ? JSBI14__default.default.divide(JSBI14__default.default.leftShift(amount, JSBI14__default.default.BigInt(96)), liquidity) : JSBI14__default.default.divide(JSBI14__default.default.multiply(amount, Q96), liquidity);
      return JSBI14__default.default.add(sqrtPX96, quotient);
    } else {
      const quotient = FullMath.mulDivRoundingUp(amount, Q96, liquidity);
      invariant18__default.default(JSBI14__default.default.greaterThan(sqrtPX96, quotient));
      return JSBI14__default.default.subtract(sqrtPX96, quotient);
    }
  }
};

// src/v3/utils/swapMath.ts
var MAX_FEE = JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(10), JSBI14__default.default.BigInt(6));
var SwapMath = class {
  /**
   * Cannot be constructed.
   */
  ...
  static computeSwapStep(sqrtRatioCurrentX96, sqrtRatioTargetX96, liquidity, amountRemaining, feePips) {
    const returnValues = {};
    feePips = JSBI14__default.default.BigInt(feePips);
    const zeroForOne = JSBI14__default.default.greaterThanOrEqual(sqrtRatioCurrentX96, sqrtRatioTargetX96);
    const exactIn = JSBI14__default.default.greaterThanOrEqual(amountRemaining, ZERO3);
    if (exactIn) {
      const amountRemainingLessFee = JSBI14__default.default.divide(
        JSBI14__default.default.multiply(amountRemaining, JSBI14__default.default.subtract(MAX_FEE, feePips)),
        MAX_FEE
      );
      ...
      if (JSBI14__default.default.greaterThanOrEqual(amountRemainingLessFee, returnValues.amountIn)) {
      ...
      if (JSBI14__default.default.greaterThanOrEqual(JSBI14__default.default.multiply(amountRemaining, NEGATIVE_ONE), returnValues.amountOut)) {
        returnValues.sqrtRatioNextX96 = sqrtRatioTargetX96;
      } else {
        returnValues.sqrtRatioNextX96 = SqrtPriceMath.getNextSqrtPriceFromOutput(
          sqrtRatioCurrentX96,
          liquidity,
          JSBI14__default.default.multiply(amountRemaining, NEGATIVE_ONE),
          zeroForOne
        );
      }
    }
    const max = JSBI14__default.default.equal(sqrtRatioTargetX96, returnValues.sqrtRatioNextX96);
    if (zeroForOne) {
    ...
    if (!exactIn && JSBI14__default.default.greaterThan(returnValues.amountOut, JSBI14__default.default.multiply(amountRemaining, NEGATIVE_ONE))) {
      returnValues.amountOut = JSBI14__default.default.multiply(amountRemaining, NEGATIVE_ONE);
    }
    if (exactIn && JSBI14__default.default.notEqual(returnValues.sqrtRatioNextX96, sqrtRatioTargetX96)) {
      returnValues.feeAmount = JSBI14__default.default.subtract(amountRemaining, returnValues.amountIn);
    } else {
      returnValues.feeAmount = FullMath.mulDivRoundingUp(
        returnValues.amountIn,
        feePips,
        JSBI14__default.default.subtract(MAX_FEE, feePips)
      );
    }
...
var LiquidityMath = class {
  ...
  static addDelta(x, y) {
    if (JSBI14__default.default.lessThan(y, ZERO3)) {
      return JSBI14__default.default.subtract(x, JSBI14__default.default.multiply(y, NEGATIVE_ONE));
    } else {
      return JSBI14__default.default.add(x, y);
    }
  }
};
var TWO2 = JSBI14__default.default.BigInt(2);
var POWERS_OF_2 = [128, 64, 32, 16, 8, 4, 2, 1].map((pow) => [
  pow,
  JSBI14__default.default.exponentiate(TWO2, JSBI14__default.default.BigInt(pow))
]);
function mostSignificantBit(x) {
  invariant18__default.default(JSBI14__default.default.greaterThan(x, ZERO3), "ZERO");
  invariant18__default.default(JSBI14__default.default.lessThanOrEqual(x, MaxUint256), "MAX");
  let msb = 0;
  for (const [power, min] of POWERS_OF_2) {
    if (JSBI14__default.default.greaterThanOrEqual(x, min)) {
      x = JSBI14__default.default.signedRightShift(x, JSBI14__default.default.BigInt(power));
      msb += power;
    }
  }
  return msb;
...
function mulShift(val, mulBy) {
  return JSBI14__default.default.signedRightShift(JSBI14__default.default.multiply(val, JSBI14__default.default.BigInt(mulBy)), JSBI14__default.default.BigInt(128));
}
var Q32 = JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(2), JSBI14__default.default.BigInt(32));
var _TickMath = class _TickMath {
  ...
  static getSqrtRatioAtTick(tick) {
    invariant18__default.default(tick >= _TickMath.MIN_TICK && tick <= _TickMath.MAX_TICK && Number.isInteger(tick), "TICK");
    const absTick = tick < 0 ? tick * -1 : tick;
    let ratio = (absTick & 1) !== 0 ? JSBI14__default.default.BigInt("0xfffcb933bd6fad37aa2d162d1a594001") : JSBI14__default.default.BigInt("0x100000000000000000000000000000000");
    ...
    if (tick > 0) ratio = JSBI14__default.default.divide(MaxUint256, ratio);
    return JSBI14__default.default.greaterThan(JSBI14__default.default.remainder(ratio, Q32), ZERO3) ? JSBI14__default.default.add(JSBI14__default.default.divide(ratio, Q32), ONE3) : JSBI14__default.default.divide(ratio, Q32);
  }
  /**
  ...
  static getTickAtSqrtRatio(sqrtRatioX96) {
    invariant18__default.default(
      JSBI14__default.default.greaterThanOrEqual(sqrtRatioX96, _TickMath.MIN_SQRT_RATIO) && JSBI14__default.default.lessThan(sqrtRatioX96, _TickMath.MAX_SQRT_RATIO),
      "SQRT_RATIO"
    );
    const sqrtRatioX128 = JSBI14__default.default.leftShift(sqrtRatioX96, JSBI14__default.default.BigInt(32));
    const msb = mostSignificantBit(sqrtRatioX128);
    let r;
    if (JSBI14__default.default.greaterThanOrEqual(JSBI14__default.default.BigInt(msb), JSBI14__default.default.BigInt(128))) {
      r = JSBI14__default.default.signedRightShift(sqrtRatioX128, JSBI14__default.default.BigInt(msb - 127));
    } else {
      r = JSBI14__default.default.leftShift(sqrtRatioX128, JSBI14__default.default.BigInt(127 - msb));
    }
    let log_2 = JSBI14__default.default.leftShift(JSBI14__default.default.subtract(JSBI14__default.default.BigInt(msb), JSBI14__default.default.BigInt(128)), JSBI14__default.default.BigInt(64));
    for (let i = 0; i < 14; i++) {
      r = JSBI14__default.default.signedRightShift(JSBI14__default.default.multiply(r, r), JSBI14__default.default.BigInt(127));
      const f = JSBI14__default.default.signedRightShift(r, JSBI14__default.default.BigInt(128));
      log_2 = JSBI14__default.default.bitwiseOr(log_2, JSBI14__default.default.leftShift(f, JSBI14__default.default.BigInt(63 - i)));
      r = JSBI14__default.default.signedRightShift(r, f);
    }
    const log_sqrt10001 = JSBI14__default.default.multiply(log_2, JSBI14__default.default.BigInt("255738958999603826347141"));
    const tickLow = JSBI14__default.default.toNumber(
      JSBI14__default.default.signedRightShift(
        JSBI14__default.default.subtract(log_sqrt10001, JSBI14__default.default.BigInt("3402992956809132418596140100660247210")),
        JSBI14__default.default.BigInt(128)
      )
    );
    const tickHigh = JSBI14__default.default.toNumber(
      JSBI14__default.default.signedRightShift(
        JSBI14__default.default.add(log_sqrt10001, JSBI14__default.default.BigInt("291339464771989622907027621153398088495")),
        JSBI14__default.default.BigInt(128)
      )
    );
    return tickLow === tickHigh ? tickLow : JSBI14__default.default.lessThanOrEqual(_TickMath.getSqrtRatioAtTick(tickHigh), sqrtRatioX96) ? tickHigh : tickLow;
  }
};
/**
 ...
 */
_TickMath.MIN_SQRT_RATIO = JSBI14__default.default.BigInt("4295128739");
/**
 * The sqrt ratio corresponding to the maximum tick that could be used on any pool.
 */
_TickMath.MAX_SQRT_RATIO = JSBI14__default.default.BigInt("1461446703485210103287273052203988822378723970342");
...
async function v3Swap(fee, sqrtRatioX96, tickCurrent, liquidity, tickSpacing, tickDataProvider, zeroForOne, amountSpecified, sqrtPriceLimitX96) {
  if (!sqrtPriceLimitX96)
    sqrtPriceLimitX96 = zeroForOne ? JSBI14__default.default.add(TickMath.MIN_SQRT_RATIO, ONE3) : JSBI14__default.default.subtract(TickMath.MAX_SQRT_RATIO, ONE3);
  if (zeroForOne) {
    invariant18__default.default(JSBI14__default.default.greaterThan(sqrtPriceLimitX96, TickMath.MIN_SQRT_RATIO), "RATIO_MIN");
    invariant18__default.default(JSBI14__default.default.lessThan(sqrtPriceLimitX96, sqrtRatioX96), "RATIO_CURRENT");
  } else {
    invariant18__default.default(JSBI14__default.default.lessThan(sqrtPriceLimitX96, TickMath.MAX_SQRT_RATIO), "RATIO_MAX");
    invariant18__default.default(JSBI14__default.default.greaterThan(sqrtPriceLimitX96, sqrtRatioX96), "RATIO_CURRENT");
  }
  const exactInput = JSBI14__default.default.greaterThanOrEqual(amountSpecified, ZERO3);
  const state = {
  ...
  while (JSBI14__default.default.notEqual(state.amountSpecifiedRemaining, ZERO3) && state.sqrtPriceX96 !== sqrtPriceLimitX96) {
    let step = {};
    ...
    [state.sqrtPriceX96, step.amountIn, step.amountOut, step.feeAmount] = SwapMath.computeSwapStep(
      state.sqrtPriceX96,
      (zeroForOne ? JSBI14__default.default.lessThan(step.sqrtPriceNextX96, sqrtPriceLimitX96) : JSBI14__default.default.greaterThan(step.sqrtPriceNextX96, sqrtPriceLimitX96)) ? sqrtPriceLimitX96 : step.sqrtPriceNextX96,
      state.liquidity,
      state.amountSpecifiedRemaining,
      fee
    );
    if (exactInput) {
      state.amountSpecifiedRemaining = JSBI14__default.default.subtract(
        state.amountSpecifiedRemaining,
        JSBI14__default.default.add(step.amountIn, step.feeAmount)
      );
      state.amountCalculated = JSBI14__default.default.subtract(state.amountCalculated, step.amountOut);
    } else {
      state.amountSpecifiedRemaining = JSBI14__default.default.add(state.amountSpecifiedRemaining, step.amountOut);
      state.amountCalculated = JSBI14__default.default.add(state.amountCalculated, JSBI14__default.default.add(step.amountIn, step.feeAmount));
    }
    if (JSBI14__default.default.equal(state.sqrtPriceX96, step.sqrtPriceNextX96)) {
      if (step.initialized) {
        let liquidityNet = JSBI14__default.default.BigInt((await tickDataProvider.getTick(step.tickNext)).liquidityNet);
        if (zeroForOne) liquidityNet = JSBI14__default.default.multiply(liquidityNet, NEGATIVE_ONE);
        state.liquidity = LiquidityMath.addDelta(state.liquidity, liquidityNet);
      }
      state.tick = zeroForOne ? step.tickNext - 1 : step.tickNext;
    } else if (JSBI14__default.default.notEqual(state.sqrtPriceX96, step.sqrtPriceStartX96)) {
...
var TickList = class _TickList {
  ...
  static validateList(ticks, tickSpacing) {
    invariant18__default.default(tickSpacing > 0, "TICK_SPACING_NONZERO");
    invariant18__default.default(
      ticks.every(({ index }) => index % tickSpacing === 0),
      "TICK_SPACING"
    );
    invariant18__default.default(
      JSBI14__default.default.equal(
        ticks.reduce((accumulator, { liquidityNet }) => JSBI14__default.default.add(accumulator, liquidityNet), ZERO3),
        ZERO3
      ),
      "ZERO_NET"
    );
    invariant18__default.default(isSorted(ticks, tickComparator), "SORTED");
  }
  static isBelowSmallest(ticks, tick) {
    invariant18__default.default(ticks.length > 0, "LENGTH");
  ...
  static getTick(ticks, index) {
    ...
    invariant18__default.default(tick.index === index, "NOT_CONTAINED");
    return tick;
  }
  /**
  ...
  static binarySearch(ticks, tick) {
    invariant18__default.default(!this.isBelowSmallest(ticks, tick), "BELOW_SMALLEST");
    let l = 0;
  ...
  static nextInitializedTick(ticks, tick, lte) {
    if (lte) {
      invariant18__default.default(!_TickList.isBelowSmallest(ticks, tick), "BELOW_SMALLEST");
      ...
      invariant18__default.default(!this.isAtOrAboveLargest(ticks, tick), "AT_OR_ABOVE_LARGEST");
...
function toHex2(bigintIsh) {
  const bigInt = JSBI14__default.default.BigInt(bigintIsh);
...
function encodeSqrtRatioX96(amount1, amount0) {
  const numerator = JSBI14__default.default.leftShift(JSBI14__default.default.BigInt(amount1), JSBI14__default.default.BigInt(192));
  const denominator = JSBI14__default.default.BigInt(amount0);
  const ratioX192 = JSBI14__default.default.divide(numerator, denominator);
...
function maxLiquidityForAmount0Imprecise(sqrtRatioAX96, sqrtRatioBX96, amount0) {
  ...
  const intermediate = JSBI14__default.default.divide(JSBI14__default.default.multiply(sqrtRatioAX96, sqrtRatioBX96), Q96);
  return JSBI14__default.default.divide(JSBI14__default.default.multiply(JSBI14__default.default.BigInt(amount0), intermediate), JSBI14__default.default.subtract(sqrtRatioBX96, sqrtRatioAX96));
}
function maxLiquidityForAmount0Precise(sqrtRatioAX96, sqrtRatioBX96, amount0) {
  if (JSBI14__default.default.greaterThan(sqrtRatioAX96, sqrtRatioBX96)) {
    [sqrtRatioAX96, sqrtRatioBX96] = [sqrtRatioBX96, sqrtRatioAX96];
  }
  const numerator = JSBI14__default.default.multiply(JSBI14__default.default.multiply(JSBI14__default.default.BigInt(amount0), sqrtRatioAX96), sqrtRatioBX96);
  const denominator = JSBI14__default.default.multiply(Q96, JSBI14__default.default.subtract(sqrtRatioBX96, sqrtRatioAX96));
  return JSBI14__default.default.divide(numerator, denominator);
}
function maxLiquidityForAmount1(sqrtRatioAX96, sqrtRatioBX96, amount1) {
  if (JSBI14__default.default.greaterThan(sqrtRatioAX96, sqrtRatioBX96)) {
    [sqrtRatioAX96, sqrtRatioBX96] = [sqrtRatioBX96, sqrtRatioAX96];
  }
  return JSBI14__default.default.divide(JSBI14__default.default.multiply(JSBI14__default.default.BigInt(amount1), Q96), JSBI14__default.default.subtract(sqrtRatioBX96, sqrtRatioAX96));
}
function maxLiquidityForAmounts(sqrtRatioCurrentX96, sqrtRatioAX96, sqrtRatioBX96, amount0, amount1, useFullPrecision) {
  ...
  if (JSBI14__default.default.lessThanOrEqual(sqrtRatioCurrentX96, sqrtRatioAX96)) {
    return maxLiquidityForAmount0(sqrtRatioAX96, sqrtRatioBX96, amount0);
  } else if (JSBI14__default.default.lessThan(sqrtRatioCurrentX96, sqrtRatioBX96)) {
    const liquidity0 = maxLiquidityForAmount0(sqrtRatioCurrentX96, sqrtRatioBX96, amount0);
    const liquidity1 = maxLiquidityForAmount1(sqrtRatioAX96, sqrtRatioCurrentX96, amount1);
    return JSBI14__default.default.lessThan(liquidity0, liquidity1) ? liquidity0 : liquidity1;
  } else {
...
function tickToPrice(baseToken, quoteToken, tick) {
  ...
  const ratioX192 = JSBI14__default.default.multiply(sqrtRatioX96, sqrtRatioX96);
...
var Tick = class {
  constructor({ index, liquidityGross, liquidityNet }) {
    invariant18__default.default(index >= TickMath.MIN_TICK && index <= TickMath.MAX_TICK, "TICK");
    this.index = index;
    this.liquidityGross = JSBI14__default.default.BigInt(liquidityGross);
    this.liquidityNet = JSBI14__default.default.BigInt(liquidityNet);
  }
};
...
var Pool = class _Pool {
  ...
  constructor(tokenA, tokenB, fee, sqrtRatioX96, liquidity, tickCurrent, ticks = NO_TICK_DATA_PROVIDER_DEFAULT) {
    invariant18__default.default(Number.isInteger(fee) && fee < 1e6, "FEE");
    const tickCurrentSqrtRatioX96 = TickMath.getSqrtRatioAtTick(tickCurrent);
    const nextTickSqrtRatioX96 = TickMath.getSqrtRatioAtTick(tickCurrent + 1);
    invariant18__default.default(
      JSBI14__default.default.greaterThanOrEqual(JSBI14__default.default.BigInt(sqrtRatioX96), tickCurrentSqrtRatioX96) && JSBI14__default.default.lessThanOrEqual(JSBI14__default.default.BigInt(sqrtRatioX96), nextTickSqrtRatioX96),
      "PRICE_BOUNDS"
    );
    [this.token0, this.token1] = tokenA.sortsBefore(tokenB) ? [tokenA, tokenB] : [tokenB, tokenA];
    this.fee = fee;
    this.sqrtRatioX96 = JSBI14__default.default.BigInt(sqrtRatioX96);
    this.liquidity = JSBI14__default.default.BigInt(liquidity);
  ...
  get token0Price() {
    return this._token0Price ?? (this._token0Price = new Price(
      ...
      this.token1,
      Q192,
      JSBI14__default.default.multiply(this.sqrtRatioX96, this.sqrtRatioX96)
    ));
  }
  /**
   ...
   */
  priceOf(token) {
    invariant18__default.default(this.involvesToken(token), "TOKEN");
  ...
  async getOutputAmount(inputAmount, sqrtPriceLimitX96) {
    invariant18__default.default(this.involvesToken(inputAmount.currency), "TOKEN");
    ...
    return [
      CurrencyAmount.fromRawAmount(outputToken, JSBI14__default.default.multiply(outputAmount, NEGATIVE_ONE)),
  ...
  async getInputAmount(outputAmount, sqrtPriceLimitX96) {
    invariant18__default.default(outputAmount.currency.isToken && this.involvesToken(outputAmount.currency), "TOKEN");
    ...
    const {
      ...
      liquidity,
      tickCurrent
    } = await this.swap(zeroForOne, JSBI14__default.default.multiply(outputAmount.quotient, NEGATIVE_ONE), sqrtPriceLimitX96);
  ...
  async swap(zeroForOne, amountSpecified, sqrtPriceLimitX96) {
    return v3Swap(
      JSBI14__default.default.BigInt(this.fee),
      this.sqrtRatioX96,
      this.tickCurrent,
      this.liquidity,
      this.tickSpacing,
...
var Position = class _Position {
  ...
  constructor({ pool, liquidity, tickLower, tickUpper }) {
    ...
    invariant18__default.default(tickLower < tickUpper, "TICK_ORDER");
    invariant18__default.default(tickLower >= TickMath.MIN_TICK && tickLower % pool.tickSpacing === 0, "TICK_LOWER");
    invariant18__default.default(tickUpper <= TickMath.MAX_TICK && tickUpper % pool.tickSpacing === 0, "TICK_UPPER");
    this.pool = pool;
  ...
  ratiosAfterSlippage(slippageTolerance) {
    ...
    if (JSBI14__default.default.lessThanOrEqual(sqrtRatioX96Lower, TickMath.MIN_SQRT_RATIO)) {
      sqrtRatioX96Lower = JSBI14__default.default.add(TickMath.MIN_SQRT_RATIO, JSBI14__default.default.BigInt(1));
    }
    let sqrtRatioX96Upper = encodeSqrtRatioX96(priceUpper.numerator, priceUpper.denominator);
    if (JSBI14__default.default.greaterThanOrEqual(sqrtRatioX96Upper, TickMath.MAX_SQRT_RATIO)) {
      sqrtRatioX96Upper = JSBI14__default.default.subtract(TickMath.MAX_SQRT_RATIO, JSBI14__default.default.BigInt(1));
    }
    return {
      sqrtRatioX96Lower,
      sqrtRatioX96Upper
...
var Route = class {
  ...
  constructor(pools, input, output) {
    this._midPrice = null;
    invariant18__default.default(pools.length > 0, "POOLS");
    const chainId = pools[0].chainId;
    const allOnSameChain = pools.every((pool) => pool.chainId === chainId);
    invariant18__default.default(allOnSameChain, "CHAIN_IDS");
    const wrappedInput = input.wrapped;
    invariant18__default.default(pools[0].involvesToken(wrappedInput), "INPUT");
    invariant18__default.default(pools[pools.length - 1].involvesToken(output.wrapped), "OUTPUT");
    const tokenPath = [wrappedInput];
    for (const [i, pool] of pools.entries()) {
      const currentInputToken = tokenPath[i];
      invariant18__default.default(currentInputToken.equals(pool.token0) || currentInputToken.equals(pool.token1), "PATH");
...
function tradeComparator(a, b) {
  invariant18__default.default(a.inputAmount.currency.equals(b.inputAmount.currency), "INPUT_CURRENCY");
  invariant18__default.default(a.outputAmount.currency.equals(b.outputAmount.currency), "OUTPUT_CURRENCY");
...
var Trade = class _Trade {
   ...
   */
  get route() {
    invariant18__default.default(this.swaps.length === 1, "MULTIPLE_ROUTES");
  ...
  static async fromRoute(route, amount, tradeType) {
    ...
    if (tradeType === 0 /* EXACT_INPUT */) {
      invariant18__default.default(amount.currency.equals(route.input), "INPUT");
      ...
      invariant18__default.default(amount.currency.equals(route.output), "OUTPUT");
  ...
  constructor({
    ...
    invariant18__default.default(numPools === poolAddressSet.size, "POOLS_DUPLICATED");
    this.swaps = routes;
  ...
  minimumAmountOut(slippageTolerance, amountOut = this.outputAmount) {
    invariant18__default.default(!slippageTolerance.lessThan(ZERO3), "SLIPPAGE_TOLERANCE");
  ...
  static async bestTradeExactIn(pools, currencyAmountIn, currencyOut, { maxNumResults = 3, maxHops = 3 } = {}, currentPools = [], nextAmountIn = currencyAmountIn, bestTrades = []) {
    invariant18__default.default(pools.length > 0, "POOLS");
    invariant18__default.default(maxHops > 0, "MAX_HOPS");
    invariant18__default.default(currencyAmountIn === nextAmountIn || currentPools.length > 0, "INVALID_RECURSION");
  ...
  static async bestTradeExactOut(pools, currencyIn, currencyAmountOut, { maxNumResults = 3, maxHops = 3 } = {}, currentPools = [], nextAmountOut = currencyAmountOut, bestTrades = []) {
    invariant18__default.default(pools.length > 0, "POOLS");
    invariant18__default.default(maxHops > 0, "MAX_HOPS");
    invariant18__default.default(currencyAmountOut === nextAmountOut || currentPools.length > 0, "INVALID_RECURSION");
...
var MaxUint128 = toHex2(JSBI14__default.default.subtract(JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(2), JSBI14__default.default.BigInt(128)), JSBI14__default.default.BigInt(1)));
...
var _NonfungiblePositionManager = class _NonfungiblePositionManager {
  ...
  static addCallParameters(position, options) {
    invariant18__default.default(JSBI14__default.default.greaterThan(position.liquidity, ZERO3), "ZERO_LIQUIDITY");
    const calldatas = [];
    ...
    if (options.useNative) {
      ...
      invariant18__default.default(position.pool.token0.equals(wrapped) || position.pool.token1.equals(wrapped), "NO_WETH");
      const wrappedValue = position.pool.token0.equals(wrapped) ? amount0Desired : amount1Desired;
      if (JSBI14__default.default.greaterThan(wrappedValue, ZERO3)) {
  ...
  static removeCallParameters(position, options) {
    ...
    invariant18__default.default(JSBI14__default.default.greaterThan(partialPosition.liquidity, ZERO3), "ZERO_LIQUIDITY");
    ...
    if (options.liquidityPercentage.equalTo(ONE3)) {
      ...
      invariant18__default.default(options.burnToken !== true, "CANNOT_BURN");
    }
    return {
      calldata: Multicall.encodeMulticall(calldatas),
      value: toHex2(0)
...
var _ApproveAndCall = class _ApproveAndCall {
  ...
  static encodeCallPositionManager(calldatas) {
    invariant18__default.default(calldatas.length > 0, "NULL_CALLDATA");
  ...
  static encodeAddLiquidity(position, minimalPosition, addLiquidityOptions, slippageTolerance) {
    ...
    if (JSBI14__default.default.lessThan(minimalPosition.amount0.quotient, amount0Min)) {
      amount0Min = minimalPosition.amount0.quotient;
    }
    if (JSBI14__default.default.lessThan(minimalPosition.amount1.quotient, amount1Min)) {
...
_ApproveAndCall.INTERFACE = new abi.Interface(IApproveAndCall__default.default.abi);
...
_MulticallExtended.INTERFACE = new abi.Interface(IMulticallExtended__default.default.abi);
...
_PaymentsExtended.INTERFACE = new abi.Interface(IPeripheryPaymentsWithFeeExtended__default.default.abi);
...
var MINIMUM_LIQUIDITY = JSBI14__default.default.BigInt(1e3);
var ZERO4 = JSBI14__default.default.BigInt(0);
var ONE4 = JSBI14__default.default.BigInt(1);
var FIVE = JSBI14__default.default.BigInt(5);
var _997 = JSBI14__default.default.BigInt(997);
var _1000 = JSBI14__default.default.BigInt(1e3);
var BASIS_POINTS = JSBI14__default.default.BigInt(1e4);
...
var Pair = class _Pair {
  ...
  getOutputAmount(inputAmount, calculateFotFees = true) {
    invariant18__default.default(this.involvesToken(inputAmount.currency), "TOKEN");
    if (JSBI14__default.default.equal(this.reserve0.quotient, ZERO4) || JSBI14__default.default.equal(this.reserve1.quotient, ZERO4)) {
    ...
    const inputAmountWithFeeAndAfterTax = JSBI14__default.default.multiply(inputAmountAfterTax.quotient, _997);
    const numerator = JSBI14__default.default.multiply(inputAmountWithFeeAndAfterTax, outputReserve.quotient);
    const denominator = JSBI14__default.default.add(JSBI14__default.default.multiply(inputReserve.quotient, _1000), inputAmountWithFeeAndAfterTax);
    const outputAmount = CurrencyAmount.fromRawAmount(
      inputAmount.currency.equals(this.token0) ? this.token1 : this.token0,
      JSBI14__default.default.divide(numerator, denominator)
      // JSBI.divide will round down by itself, which is desired
    );
    if (JSBI14__default.default.equal(outputAmount.quotient, ZERO4)) {
    ...
    if (JSBI14__default.default.equal(outputAmountAfterTax.quotient, ZERO4)) {
      throw new InsufficientInputAmountError();
    }
    return [
  ...
  getInputAmount(outputAmount, calculateFotFees = true) {
    invariant18__default.default(this.involvesToken(outputAmount.currency), "TOKEN");
    const percentAfterBuyFees = calculateFotFees ? this.derivePercentAfterBuyFees(outputAmount) : ZERO_PERCENT2;
    const outputAmountBeforeTax = percentAfterBuyFees.greaterThan(ZERO_PERCENT2) ? CurrencyAmount.fromRawAmount(
      outputAmount.currency,
      JSBI14__default.default.add(outputAmount.divide(percentAfterBuyFees).quotient, ONE4)
      // add 1 for rounding up
    ) : outputAmount;
    if (JSBI14__default.default.equal(this.reserve0.quotient, ZERO4) || JSBI14__default.default.equal(this.reserve1.quotient, ZERO4) || JSBI14__default.default.greaterThanOrEqual(outputAmount.quotient, this.reserveOf(outputAmount.currency).quotient) || JSBI14__default.default.greaterThanOrEqual(outputAmountBeforeTax.quotient, this.reserveOf(outputAmount.currency).quotient)) {
      throw new InsufficientReservesError();
    }
    const outputReserve = this.reserveOf(outputAmount.currency);
    const inputReserve = this.reserveOf(outputAmount.currency.equals(this.token0) ? this.token1 : this.token0);
    const numerator = JSBI14__default.default.multiply(JSBI14__default.default.multiply(inputReserve.quotient, outputAmountBeforeTax.quotient), _1000);
    const denominator = JSBI14__default.default.multiply(JSBI14__default.default.subtract(outputReserve.quotient, outputAmountBeforeTax.quotient), _997);
    const inputAmount = CurrencyAmount.fromRawAmount(
      outputAmount.currency.equals(this.token0) ? this.token1 : this.token0,
      JSBI14__default.default.add(JSBI14__default.default.divide(numerator, denominator), ONE4)
    ...
    const inputAmountBeforeTax = percentAfterSellFees.greaterThan(ZERO_PERCENT2) ? CurrencyAmount.fromRawAmount(
      inputAmount.currency,
      JSBI14__default.default.add(inputAmount.divide(percentAfterSellFees).quotient, ONE4)
      // add 1 for rounding up
    ) : inputAmount;
    return [inputAmountBeforeTax, new _Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))];
  }
  getLiquidityMinted(totalSupply, tokenAmountA, tokenAmountB) {
    invariant18__default.default(totalSupply.currency.equals(this.liquidityToken), "LIQUIDITY");
    ...
    invariant18__default.default(tokenAmounts[0].currency.equals(this.token0) && tokenAmounts[1].currency.equals(this.token1), "TOKEN");
    let liquidity;
    if (JSBI14__default.default.equal(totalSupply.quotient, ZERO4)) {
      liquidity = JSBI14__default.default.subtract(
        sqrt(JSBI14__default.default.multiply(tokenAmounts[0].quotient, tokenAmounts[1].quotient)),
        MINIMUM_LIQUIDITY
      );
    } else {
      const amount0 = JSBI14__default.default.divide(JSBI14__default.default.multiply(tokenAmounts[0].quotient, totalSupply.quotient), this.reserve0.quotient);
      const amount1 = JSBI14__default.default.divide(JSBI14__default.default.multiply(tokenAmounts[1].quotient, totalSupply.quotient), this.reserve1.quotient);
      liquidity = JSBI14__default.default.lessThanOrEqual(amount0, amount1) ? amount0 : amount1;
    }
    if (!JSBI14__default.default.greaterThan(liquidity, ZERO4)) {
      throw new InsufficientInputAmountError();
    }
  ...
  getLiquidityValue(token, totalSupply, liquidity, feeOn = false, kLast) {
    invariant18__default.default(this.involvesToken(token), "TOKEN");
    invariant18__default.default(totalSupply.currency.equals(this.liquidityToken), "TOTAL_SUPPLY");
    invariant18__default.default(liquidity.currency.equals(this.liquidityToken), "LIQUIDITY");
    invariant18__default.default(JSBI14__default.default.lessThanOrEqual(liquidity.quotient, totalSupply.quotient), "LIQUIDITY");
    let totalSupplyAdjusted;
    if (!feeOn) {
      totalSupplyAdjusted = totalSupply;
    } else {
      invariant18__default.default(!!kLast, "K_LAST");
      const kLastParsed = JSBI14__default.default.BigInt(kLast);
      if (!JSBI14__default.default.equal(kLastParsed, ZERO4)) {
        const rootK = sqrt(JSBI14__default.default.multiply(this.reserve0.quotient, this.reserve1.quotient));
        const rootKLast = sqrt(kLastParsed);
        if (JSBI14__default.default.greaterThan(rootK, rootKLast)) {
          const numerator = JSBI14__default.default.multiply(totalSupply.quotient, JSBI14__default.default.subtract(rootK, rootKLast));
          const denominator = JSBI14__default.default.add(JSBI14__default.default.multiply(rootK, FIVE), rootKLast);
          const feeLiquidity = JSBI14__default.default.divide(numerator, denominator);
    ...
    return CurrencyAmount.fromRawAmount(
      token,
      JSBI14__default.default.divide(JSBI14__default.default.multiply(liquidity.quotient, this.reserveOf(token).quotient), totalSupplyAdjusted.quotient)
    );
  }
  derivePercentAfterSellFees(inputAmount) {
    ...
    if (sellFeeBips?.gt(BigNumber.from(0))) {
      return ONE_HUNDRED_PERCENT2.subtract(new Percent(JSBI14__default.default.BigInt(sellFeeBips)).divide(BASIS_POINTS));
    } else {
  ...
  derivePercentAfterBuyFees(outputAmount) {
    ...
    if (buyFeeBps?.gt(BigNumber.from(0))) {
      return ONE_HUNDRED_PERCENT2.subtract(new Percent(JSBI14__default.default.BigInt(buyFeeBps)).divide(BASIS_POINTS));
    } else {
      return ZERO_PERCENT2;
    }
  }
...
var Route2 = class {
  constructor(pairs, input, output) {
    this._midPrice = null;
    invariant18__default.default(pairs.length > 0, "PAIRS");
    ...
    const wrappedInput = input.wrapped;
    invariant18__default.default(pairs[0].involvesToken(wrappedInput), "INPUT");
    invariant18__default.default(typeof output === "undefined" || pairs[pairs.length - 1].involvesToken(output.wrapped), "OUTPUT");
    const path = [wrappedInput];
    for (const [i, pair] of pairs.entries()) {
      const currentInput = path[i];
      invariant18__default.default(currentInput.equals(pair.token0) || currentInput.equals(pair.token1), "PATH");
...
var Trade2 = class _Trade {
  ...
  minimumAmountOut(slippageTolerance) {
    invariant18__default.default(!slippageTolerance.lessThan(ZERO4), "SLIPPAGE_TOLERANCE");
    if (this.tradeType === 1 /* EXACT_OUTPUT */) {
  ...
  static bestTradeExactIn(pairs, currencyAmountIn, currencyOut, { maxNumResults = 3, maxHops = 3 } = {}, currentPairs = [], nextAmountIn = currencyAmountIn, bestTrades = []) {
    invariant18__default.default(pairs.length > 0, "PAIRS");
    invariant18__default.default(maxHops > 0, "MAX_HOPS");
    invariant18__default.default(currencyAmountIn === nextAmountIn || currentPairs.length > 0, "INVALID_RECURSION");
    const amountIn = nextAmountIn.wrapped;
    const tokenOut = currencyOut.wrapped;
  ...
  static bestTradeExactOut(pairs, currencyIn, currencyAmountOut, { maxNumResults = 3, maxHops = 3 } = {}, currentPairs = [], nextAmountOut = currencyAmountOut, bestTrades = []) {
    invariant18__default.default(pairs.length > 0, "PAIRS");
    invariant18__default.default(maxHops > 0, "MAX_HOPS");
    invariant18__default.default(currencyAmountOut === nextAmountOut || currentPairs.length > 0, "INVALID_RECURSION");
    const amountOut = nextAmountOut.wrapped;
    const tokenIn = currencyIn.wrapped;
    for (let i = 0; i < pairs.length; i++) {
      const pair = pairs[i];
...
var Hook = class _Hook {
  ...
  static _checkAddress(address) {
    invariant18__default.default(utils.isAddress(address), "invalid address");
  }
};
var ADDRESS_ZERO3 = ethers.constants.AddressZero;
var NEGATIVE_ONE2 = JSBI14__default.default.BigInt(-1);
var ZERO5 = JSBI14__default.default.BigInt(0);
var ONE5 = JSBI14__default.default.BigInt(1);
JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(10), JSBI14__default.default.BigInt(18));
var Q962 = JSBI14__default.default.exponentiate(JSBI14__default.default.BigInt(2), JSBI14__default.default.BigInt(96));
var Q1922 = JSBI14__default.default.exponentiate(Q962, JSBI14__default.default.BigInt(2));
...
var Pool2 = class _Pool {
  static getPoolKey(currencyA, currencyB, fee, tickSpacing, hooks) {
    invariant18__default.default(utils.isAddress(hooks), "Invalid hook address");
  ...
  constructor(currencyA, currencyB, fee, tickSpacing, hooks, sqrtRatioX96, liquidity, tickCurrent, ticks = NO_TICK_DATA_PROVIDER_DEFAULT2) {
    invariant18__default.default(utils.isAddress(hooks), "Invalid hook address");
    invariant18__default.default(Number.isInteger(fee) && (fee === DYNAMIC_FEE_FLAG || fee < 1e6), "FEE");
    if (fee === DYNAMIC_FEE_FLAG) {
      invariant18__default.default(Number(hooks) > 0, "Dynamic fee pool requires a hook");
    }
    const tickCurrentSqrtRatioX96 = TickMath.getSqrtRatioAtTick(tickCurrent);
    const nextTickSqrtRatioX96 = TickMath.getSqrtRatioAtTick(tickCurrent + 1);
    invariant18__default.default(
   ...
   */
  priceOf(currency) {
    invariant18__default.default(this.involvesCurrency(currency), "CURRENCY");
  ...
  async getOutputAmount(inputAmount, sqrtPriceLimitX96) {
    invariant18__default.default(this.involvesCurrency(inputAmount.currency), "CURRENCY");
    ...
    return [
      CurrencyAmount.fromRawAmount(outputCurrency, JSBI14__default.default.multiply(outputAmount, NEGATIVE_ONE2)),
      new _Pool(
        this.currency0,
        this.currency1,
        this.fee,
   ...
   */
  async getInputAmount(outputAmount, sqrtPriceLimitX96) {
    invariant18__default.default(this.involvesCurrency(outputAmount.currency), "CURRENCY");
    ...
    const {
      ...
      liquidity,
      tickCurrent
    } = await this.swap(zeroForOne, JSBI14__default.default.multiply(outputAmount.quotient, NEGATIVE_ONE2), sqrtPriceLimitX96);
...
var Route3 = class {
  ...
  constructor(pools, input, output) {
    ...
    for (const [i, pool] of pools.entries()) {
      ...
      invariant18__default.default(currentInputCurrency.equals(pool.currency0) || currentInputCurrency.equals(pool.currency1), "PATH");
...
var Trade3 = class _Trade {
  ...
  constructor({
    ...
    invariant18__default.default(numPools === poolIDSet.size, "POOLS_DUPLICATED");
    this.swaps = routes;
    this.tradeType = tradeType;
  }
  /**
   ...
   */
  minimumAmountOut(slippageTolerance, amountOut = this.outputAmount) {
    invariant18__default.default(!slippageTolerance.lessThan(ZERO5), "SLIPPAGE_TOLERANCE");
    if (this.tradeType === 1 /* EXACT_OUTPUT */) {
      return amountOut;
    } else {
...
var MixedRouteSDK = class {
  ...
  constructor(pools, input, output, retainFakePools = false) {
    ...
    if (!(pools[0] instanceof Pool2)) {
      invariant18__default.default(pools[0].involvesToken(this.pathInput), "INPUT");
    } else {
      invariant18__default.default(pools[0].v4InvolvesToken(this.pathInput), "INPUT");
    }
    const lastPool = pools[pools.length - 1];
    if (lastPool instanceof Pool2) {
      invariant18__default.default(lastPool.v4InvolvesToken(output) || lastPool.v4InvolvesToken(output.wrapped), "OUTPUT");
    } else {
      invariant18__default.default(lastPool.involvesToken(output.wrapped), "OUTPUT");
    }
...
var MixedRouteTrade = class _MixedRouteTrade {
  ...
  static async fromRoute(route, amount, tradeType) {
    ...
    let inputAmount;
    let outputAmount;
    invariant18__default.default(tradeType === 0 /* EXACT_INPUT */, "TRADE_TYPE");
    invariant18__default.default(amount.currency.equals(route.input), "INPUT");
  ...
  constructor({
    ...
    invariant18__default.default(numPools === poolIdentifierSet.size, "POOLS_DUPLICATED");
    invariant18__default.default(tradeType === 0 /* EXACT_INPUT */, "TRADE_TYPE");
    this.swaps = routes;
    this.tradeType = tradeType;
  }
   ...
   */
  minimumAmountOut(slippageTolerance, amountOut = this.outputAmount) {
    invariant18__default.default(!slippageTolerance.lessThan(ZERO2), "SLIPPAGE_TOLERANCE");
...
var ZERO6 = JSBI14__default.default.BigInt(0);
var REFUND_ETH_PRICE_IMPACT_THRESHOLD = new Percent(JSBI14__default.default.BigInt(50), JSBI14__default.default.BigInt(100));
var _SwapRouter = class _SwapRouter {
  ...
  static encodeMixedRouteSwap(trade, options, routerMustCustody, performAggregatedSlippageCheck) {
    const calldatas = [];
    invariant18__default.default(trade.tradeType === 0 /* EXACT_INPUT */, "TRADE_TYPE");
    for (const { route, inputAmount, outputAmount } of trade.swaps) {
  ...
  static encodeSwaps(trades, options, isSwapAndAdd) {
    ...
    if (options.inputTokenPermit) {
      invariant18__default.default(sampleTrade.inputAmount.currency.isToken, "NON_TOKEN_PERMIT");
  ...
  static swapAndAddCallParameters(trades, options, position, addLiquidityOptions, tokenInApprovalType, tokenOutApprovalType) {
    ...
    if (options.outputTokenPermit) {
      invariant18__default.default(quoteAmountOut.currency.isToken, "NON_TOKEN_PERMIT_OUTPUT");
...
_SwapRouter.INTERFACE = new abi.Interface(ISwapRouter02__default.default.abi);
