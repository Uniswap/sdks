...
var JSBI8__default = /*#__PURE__*/_interopDefault(JSBI8);
...
var MaxUint256 = JSBI8__default.default.BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
var RoundingMode = {
  RoundDown: 0,
  RoundHalfUp: 1,
  RoundUp: 3
...
var Fraction = class _Fraction {
  constructor(numerator, denominator = JSBI8__default.default.BigInt(1)) {
    this.numerator = JSBI8__default.default.BigInt(numerator);
    this.denominator = JSBI8__default.default.BigInt(denominator);
  }
  static tryParseFraction(fractionish) {
    if (fractionish instanceof JSBI8__default.default || typeof fractionish === "number" || typeof fractionish === "string")
  ...
  get quotient() {
    return JSBI8__default.default.divide(this.numerator, this.denominator);
  }
  // remainder after floor division
  get remainder() {
    return new _Fraction(JSBI8__default.default.remainder(this.numerator, this.denominator), this.denominator);
  }
  invert() {
  ...
  add(other) {
    ...
    if (JSBI8__default.default.equal(this.denominator, otherParsed.denominator)) {
      return new _Fraction(JSBI8__default.default.add(this.numerator, otherParsed.numerator), this.denominator);
    }
    return new _Fraction(
      JSBI8__default.default.add(
        JSBI8__default.default.multiply(this.numerator, otherParsed.denominator),
        JSBI8__default.default.multiply(otherParsed.numerator, this.denominator)
      ),
      JSBI8__default.default.multiply(this.denominator, otherParsed.denominator)
    );
  }
  subtract(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    if (JSBI8__default.default.equal(this.denominator, otherParsed.denominator)) {
      return new _Fraction(JSBI8__default.default.subtract(this.numerator, otherParsed.numerator), this.denominator);
    }
    return new _Fraction(
      JSBI8__default.default.subtract(
        JSBI8__default.default.multiply(this.numerator, otherParsed.denominator),
        JSBI8__default.default.multiply(otherParsed.numerator, this.denominator)
      ),
      JSBI8__default.default.multiply(this.denominator, otherParsed.denominator)
  ...
  lessThan(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    return JSBI8__default.default.lessThan(
      JSBI8__default.default.multiply(this.numerator, otherParsed.denominator),
      JSBI8__default.default.multiply(otherParsed.numerator, this.denominator)
    );
  }
  equalTo(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    return JSBI8__default.default.equal(
      JSBI8__default.default.multiply(this.numerator, otherParsed.denominator),
      JSBI8__default.default.multiply(otherParsed.numerator, this.denominator)
    );
  }
  greaterThan(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    return JSBI8__default.default.greaterThan(
      JSBI8__default.default.multiply(this.numerator, otherParsed.denominator),
      JSBI8__default.default.multiply(otherParsed.numerator, this.denominator)
    );
  }
  multiply(other) {
    const otherParsed = _Fraction.tryParseFraction(other);
    return new _Fraction(
      JSBI8__default.default.multiply(this.numerator, otherParsed.numerator),
      JSBI8__default.default.multiply(this.denominator, otherParsed.denominator)
    );
  }
  divide(other) {
    ...
    return new _Fraction(
      JSBI8__default.default.multiply(this.numerator, otherParsed.denominator),
      JSBI8__default.default.multiply(this.denominator, otherParsed.numerator)
    );
  }
  toSignificant(significantDigits, format = { groupSeparator: "" }, rounding = 1 /* ROUND_HALF_UP */) {
    invariant10__default.default(Number.isInteger(significantDigits), `${significantDigits} is not an integer.`);
    invariant10__default.default(significantDigits > 0, `${significantDigits} is not positive.`);
    Decimal.set({ precision: significantDigits + 1, rounding: toSignificantRounding[rounding] });
    const quotient = new Decimal(this.numerator.toString()).div(this.denominator.toString()).toSignificantDigits(significantDigits);
    return quotient.toFormat(quotient.decimalPlaces(), format);
  }
  toFixed(decimalPlaces, format = { groupSeparator: "" }, rounding = 1 /* ROUND_HALF_UP */) {
    invariant10__default.default(Number.isInteger(decimalPlaces), `${decimalPlaces} is not an integer.`);
    invariant10__default.default(decimalPlaces >= 0, `${decimalPlaces} is negative.`);
...
var CurrencyAmount = class _CurrencyAmount extends Fraction {
  ...
  constructor(currency, numerator, denominator) {
    ...
    invariant10__default.default(JSBI8__default.default.lessThanOrEqual(this.quotient, MaxUint256), "AMOUNT");
    this.currency = currency;
    this.decimalScale = JSBI8__default.default.exponentiate(JSBI8__default.default.BigInt(10), JSBI8__default.default.BigInt(currency.decimals));
  }
  add(other) {
    invariant10__default.default(this.currency.equals(other.currency), "CURRENCY");
  ...
  toFixed(decimalPlaces = this.currency.decimals, format, rounding = 0 /* ROUND_DOWN */) {
    invariant10__default.default(decimalPlaces <= this.currency.decimals, "DECIMALS");
...
var ONE_HUNDRED = new Fraction(JSBI8__default.default.BigInt(100));
...
var Price = class _Price extends Fraction {
  ...
  constructor(...args) {
    ...
    this.scalar = new Fraction(
      JSBI8__default.default.exponentiate(JSBI8__default.default.BigInt(10), JSBI8__default.default.BigInt(baseCurrency.decimals)),
      JSBI8__default.default.exponentiate(JSBI8__default.default.BigInt(10), JSBI8__default.default.BigInt(quoteCurrency.decimals))
    );
  }
  /**
   ...
   */
  multiply(other) {
    invariant10__default.default(this.quoteCurrency.equals(other.baseCurrency), "TOKEN");
  ...
  quote(currencyAmount) {
    invariant10__default.default(currencyAmount.currency.equals(this.baseCurrency), "TOKEN");
...
var BaseCurrency = class {
  ...
  constructor(chainId, decimals, symbol, name) {
    invariant10__default.default(Number.isSafeInteger(chainId), "CHAIN_ID");
    invariant10__default.default(decimals >= 0 && decimals < 255 && Number.isInteger(decimals), "DECIMALS");
...
var Token = class extends BaseCurrency {
  ...
  constructor(chainId, address, decimals, symbol, name, bypassChecksum, buyFeeBps, sellFeeBps) {
    ...
    if (buyFeeBps) {
      invariant10__default.default(buyFeeBps.gte(BigNumber.from(0)), "NON-NEGATIVE FOT FEES");
    }
    if (sellFeeBps) {
      invariant10__default.default(sellFeeBps.gte(BigNumber.from(0)), "NON-NEGATIVE FOT FEES");
    }
   ...
   */
  sortsBefore(other) {
    invariant10__default.default(this.chainId === other.chainId, "CHAIN_IDS");
    invariant10__default.default(this.address.toLowerCase() !== other.address.toLowerCase(), "ADDRESSES");
...
function sortedInsert(items, add, maxSize, comparator) {
  invariant10__default.default(maxSize > 0, "MAX_SIZE_ZERO");
  invariant10__default.default(items.length <= maxSize, "ITEMS_SIZE");
  if (items.length === 0) {
    items.push(add);
    return null;
  } else {
...
var MAX_SAFE_INTEGER = JSBI8__default.default.BigInt(Number.MAX_SAFE_INTEGER);
var ZERO = JSBI8__default.default.BigInt(0);
var ONE = JSBI8__default.default.BigInt(1);
var TWO = JSBI8__default.default.BigInt(2);
function sqrt(value) {
  invariant10__default.default(JSBI8__default.default.greaterThanOrEqual(value, ZERO), "NEGATIVE");
  if (JSBI8__default.default.lessThan(value, MAX_SAFE_INTEGER)) {
    return JSBI8__default.default.BigInt(Math.floor(Math.sqrt(JSBI8__default.default.toNumber(value))));
  }
  let z;
  let x;
  z = value;
  x = JSBI8__default.default.add(JSBI8__default.default.divide(value, TWO), ONE);
  while (JSBI8__default.default.lessThan(x, z)) {
    z = x;
    x = JSBI8__default.default.divide(JSBI8__default.default.add(JSBI8__default.default.divide(value, x), x), TWO);
  }
  return z;
}
...
var MINIMUM_LIQUIDITY = JSBI8__default.default.BigInt(1e3);
var ZERO2 = JSBI8__default.default.BigInt(0);
var ONE2 = JSBI8__default.default.BigInt(1);
var FIVE = JSBI8__default.default.BigInt(5);
var _997 = JSBI8__default.default.BigInt(997);
var _1000 = JSBI8__default.default.BigInt(1e3);
var BASIS_POINTS = JSBI8__default.default.BigInt(1e4);
var ZERO_PERCENT = new Percent(ZERO2);
var ONE_HUNDRED_PERCENT = new Percent(ONE2);
...
var Pair = class _Pair {
   ...
   */
  priceOf(token) {
    invariant10__default.default(this.involvesToken(token), "TOKEN");
  ...
  getOutputAmount(inputAmount, calculateFotFees = true) {
    invariant10__default.default(this.involvesToken(inputAmount.currency), "TOKEN");
    if (JSBI8__default.default.equal(this.reserve0.quotient, ZERO2) || JSBI8__default.default.equal(this.reserve1.quotient, ZERO2)) {
    ...
    const inputAmountWithFeeAndAfterTax = JSBI8__default.default.multiply(inputAmountAfterTax.quotient, _997);
    const numerator = JSBI8__default.default.multiply(inputAmountWithFeeAndAfterTax, outputReserve.quotient);
    const denominator = JSBI8__default.default.add(JSBI8__default.default.multiply(inputReserve.quotient, _1000), inputAmountWithFeeAndAfterTax);
    const outputAmount = CurrencyAmount.fromRawAmount(
      inputAmount.currency.equals(this.token0) ? this.token1 : this.token0,
      JSBI8__default.default.divide(numerator, denominator)
      // JSBI.divide will round down by itself, which is desired
    );
    if (JSBI8__default.default.equal(outputAmount.quotient, ZERO2)) {
    ...
    if (JSBI8__default.default.equal(outputAmountAfterTax.quotient, ZERO2)) {
      throw new InsufficientInputAmountError();
    }
    return [
  ...
  getInputAmount(outputAmount, calculateFotFees = true) {
    invariant10__default.default(this.involvesToken(outputAmount.currency), "TOKEN");
    const percentAfterBuyFees = calculateFotFees ? this.derivePercentAfterBuyFees(outputAmount) : ZERO_PERCENT;
    const outputAmountBeforeTax = percentAfterBuyFees.greaterThan(ZERO_PERCENT) ? CurrencyAmount.fromRawAmount(
      outputAmount.currency,
      JSBI8__default.default.add(outputAmount.divide(percentAfterBuyFees).quotient, ONE2)
      // add 1 for rounding up
    ) : outputAmount;
    if (JSBI8__default.default.equal(this.reserve0.quotient, ZERO2) || JSBI8__default.default.equal(this.reserve1.quotient, ZERO2) || JSBI8__default.default.greaterThanOrEqual(outputAmount.quotient, this.reserveOf(outputAmount.currency).quotient) || JSBI8__default.default.greaterThanOrEqual(outputAmountBeforeTax.quotient, this.reserveOf(outputAmount.currency).quotient)) {
      throw new InsufficientReservesError();
    }
    const outputReserve = this.reserveOf(outputAmount.currency);
    const inputReserve = this.reserveOf(outputAmount.currency.equals(this.token0) ? this.token1 : this.token0);
    const numerator = JSBI8__default.default.multiply(JSBI8__default.default.multiply(inputReserve.quotient, outputAmountBeforeTax.quotient), _1000);
    const denominator = JSBI8__default.default.multiply(JSBI8__default.default.subtract(outputReserve.quotient, outputAmountBeforeTax.quotient), _997);
    const inputAmount = CurrencyAmount.fromRawAmount(
      outputAmount.currency.equals(this.token0) ? this.token1 : this.token0,
      JSBI8__default.default.add(JSBI8__default.default.divide(numerator, denominator), ONE2)
    ...
    const inputAmountBeforeTax = percentAfterSellFees.greaterThan(ZERO_PERCENT) ? CurrencyAmount.fromRawAmount(
      inputAmount.currency,
      JSBI8__default.default.add(inputAmount.divide(percentAfterSellFees).quotient, ONE2)
      // add 1 for rounding up
    ) : inputAmount;
    return [inputAmountBeforeTax, new _Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))];
  }
  getLiquidityMinted(totalSupply, tokenAmountA, tokenAmountB) {
    invariant10__default.default(totalSupply.currency.equals(this.liquidityToken), "LIQUIDITY");
    ...
    invariant10__default.default(tokenAmounts[0].currency.equals(this.token0) && tokenAmounts[1].currency.equals(this.token1), "TOKEN");
    let liquidity;
    if (JSBI8__default.default.equal(totalSupply.quotient, ZERO2)) {
      liquidity = JSBI8__default.default.subtract(
        sqrt(JSBI8__default.default.multiply(tokenAmounts[0].quotient, tokenAmounts[1].quotient)),
        MINIMUM_LIQUIDITY
      );
    } else {
      const amount0 = JSBI8__default.default.divide(JSBI8__default.default.multiply(tokenAmounts[0].quotient, totalSupply.quotient), this.reserve0.quotient);
      const amount1 = JSBI8__default.default.divide(JSBI8__default.default.multiply(tokenAmounts[1].quotient, totalSupply.quotient), this.reserve1.quotient);
      liquidity = JSBI8__default.default.lessThanOrEqual(amount0, amount1) ? amount0 : amount1;
    }
    if (!JSBI8__default.default.greaterThan(liquidity, ZERO2)) {
      throw new InsufficientInputAmountError();
    }
  ...
  getLiquidityValue(token, totalSupply, liquidity, feeOn = false, kLast) {
    invariant10__default.default(this.involvesToken(token), "TOKEN");
    invariant10__default.default(totalSupply.currency.equals(this.liquidityToken), "TOTAL_SUPPLY");
    invariant10__default.default(liquidity.currency.equals(this.liquidityToken), "LIQUIDITY");
    invariant10__default.default(JSBI8__default.default.lessThanOrEqual(liquidity.quotient, totalSupply.quotient), "LIQUIDITY");
    let totalSupplyAdjusted;
    if (!feeOn) {
      totalSupplyAdjusted = totalSupply;
    } else {
      invariant10__default.default(!!kLast, "K_LAST");
      const kLastParsed = JSBI8__default.default.BigInt(kLast);
      if (!JSBI8__default.default.equal(kLastParsed, ZERO2)) {
        const rootK = sqrt(JSBI8__default.default.multiply(this.reserve0.quotient, this.reserve1.quotient));
        const rootKLast = sqrt(kLastParsed);
        if (JSBI8__default.default.greaterThan(rootK, rootKLast)) {
          const numerator = JSBI8__default.default.multiply(totalSupply.quotient, JSBI8__default.default.subtract(rootK, rootKLast));
          const denominator = JSBI8__default.default.add(JSBI8__default.default.multiply(rootK, FIVE), rootKLast);
          const feeLiquidity = JSBI8__default.default.divide(numerator, denominator);
    ...
    return CurrencyAmount.fromRawAmount(
      token,
      JSBI8__default.default.divide(JSBI8__default.default.multiply(liquidity.quotient, this.reserveOf(token).quotient), totalSupplyAdjusted.quotient)
    );
  }
  derivePercentAfterSellFees(inputAmount) {
    ...
    if (sellFeeBips?.gt(BigNumber.from(0))) {
      return ONE_HUNDRED_PERCENT.subtract(new Percent(JSBI8__default.default.BigInt(sellFeeBips)).divide(BASIS_POINTS));
    } else {
      return ZERO_PERCENT;
    }
  }
  derivePercentAfterBuyFees(outputAmount) {
    ...
    if (buyFeeBps?.gt(BigNumber.from(0))) {
      return ONE_HUNDRED_PERCENT.subtract(new Percent(JSBI8__default.default.BigInt(buyFeeBps)).divide(BASIS_POINTS));
    } else {
      return ZERO_PERCENT;
    }
  }
...
var Route = class {
  constructor(pairs, input, output) {
    this._midPrice = null;
    invariant10__default.default(pairs.length > 0, "PAIRS");
    ...
    invariant10__default.default(pairs[0].involvesToken(wrappedInput), "INPUT");
    invariant10__default.default(typeof output === "undefined" || pairs[pairs.length - 1].involvesToken(output.wrapped), "OUTPUT");
    const path = [wrappedInput];
    for (const [i, pair] of pairs.entries()) {
      const currentInput = path[i];
      invariant10__default.default(currentInput.equals(pair.token0) || currentInput.equals(pair.token1), "PATH");
...
function inputOutputComparator(a, b) {
  invariant10__default.default(a.inputAmount.currency.equals(b.inputAmount.currency), "INPUT_CURRENCY");
  invariant10__default.default(a.outputAmount.currency.equals(b.outputAmount.currency), "OUTPUT_CURRENCY");
...
var Trade = class _Trade {
  ...
  constructor(route, amount, tradeType) {
    ...
    if (tradeType === 0 /* EXACT_INPUT */) {
      invariant10__default.default(amount.currency.equals(route.input), "INPUT");
      ...
      invariant10__default.default(amount.currency.equals(route.output), "OUTPUT");
  ...
  minimumAmountOut(slippageTolerance) {
    invariant10__default.default(!slippageTolerance.lessThan(ZERO2), "SLIPPAGE_TOLERANCE");
  ...
  static bestTradeExactIn(pairs, currencyAmountIn, currencyOut, { maxNumResults = 3, maxHops = 3 } = {}, currentPairs = [], nextAmountIn = currencyAmountIn, bestTrades = []) {
    invariant10__default.default(pairs.length > 0, "PAIRS");
    invariant10__default.default(maxHops > 0, "MAX_HOPS");
    invariant10__default.default(currencyAmountIn === nextAmountIn || currentPairs.length > 0, "INVALID_RECURSION");
  ...
  static bestTradeExactOut(pairs, currencyIn, currencyAmountOut, { maxNumResults = 3, maxHops = 3 } = {}, currentPairs = [], nextAmountOut = currencyAmountOut, bestTrades = []) {
    invariant10__default.default(pairs.length > 0, "PAIRS");
    invariant10__default.default(maxHops > 0, "MAX_HOPS");
    invariant10__default.default(currencyAmountOut === nextAmountOut || currentPairs.length > 0, "INVALID_RECURSION");
...
var Router = class {
  ...
  static swapCallParameters(trade, options) {
    ...
    invariant10__default.default(!(etherIn && etherOut), "ETHER_IN_OUT");
    invariant10__default.default(!("ttl" in options) || options.ttl > 0, "TTL");
    ...
    switch (trade.tradeType) {
      case 0 /* EXACT_INPUT */:
        ...
        break;
      case 1 /* EXACT_OUTPUT */:
        invariant10__default.default(!useFeeOnTransfer, "EXACT_OUT_FOT");
        if (etherIn) {
